...
describe('c3 chart data', function () {
    ...
    describe('load json', function () {
        ...
        it('should draw correctly', function () {
            ...
            d3.selectAll('.c3-circles-data1 .c3-circle').each(function (d, i) {
                ...
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[i], 0);
            });
        });
        ...
        it('should draw correctly', function () {
            ...
            d3.selectAll('.c3-circles-443 .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[443][i], 0);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[443][i], 0);
            });
            d3.selectAll('.c3-circles-995 .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[995][i], 0);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[995][i], 0);
            });
        });
        ...
        it('should draw nested JSON correctly', function () {
            ...
            d3.selectAll('.c3-circles-112-0- .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[i], 0);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[112][i], 0);
            });

            d3.selectAll('.c3-circles-223-0--224 .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[i], 0);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[223][i], 0);
            });

            d3.selectAll('.c3-circles-334-1--0--335 .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[i], 0);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[334][i], 0);
            });

            d3.selectAll('.c3-circles-556-557-558-0- .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[i], 0);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[556][i], 0);
            });
        });
    ...
    describe('function in data.order', function () {
        ...
        it('should return false in isOrderAsc and isOrderDesc functions', function () {
            expect(chart.internal.isOrderAsc() || chart.internal.isOrderDesc()).to.equal(false);
        });
    });
    ...
    describe('data.xs', function () {
        ...
        describe('normal x', function () {
            ...
            it('should have correct number of xs for each', function () {
                expect(Object.keys(chart.internal.data.xs).length).to.equal(3);
                expect(chart.internal.data.xs.data1.length).to.equal(6);
                expect(chart.internal.data.xs.data2.length).to.equal(6);
                expect(chart.internal.data.xs.data3.length).to.equal(6);
            });

            it('should have integer index as x', function () {
                for (var i = 0; i < chart.internal.data.xs.data3.length; i++) {
                    expect(chart.internal.data.xs.data1[i]).to.equal(i);
                    expect(chart.internal.data.xs.data2[i]).to.equal(i);
                    expect(chart.internal.data.xs.data3[i]).to.equal(i);
                }
            });
        ...
        describe('timeseries x', function () {
            describe('without xFormat', function () {
                ...
                it('should have correct number of xs', function () {
                    expect(Object.keys(chart.internal.data.xs).length).to.equal(2);
                    expect(chart.internal.data.xs.data1.length).to.equal(3);
                    expect(chart.internal.data.xs.data2.length).to.equal(3);
                });

                it('should have Date object as x', function () {
                    var xs = chart.internal.data.xs;
                    expect(+xs.data1[0]).to.equal(+new Date(2013, 0, 1, 0, 0, 0));
                    expect(+xs.data1[1]).to.equal(+new Date(2013, 0, 2, 0, 0, 0));
                    expect(+xs.data1[2]).to.equal(+new Date(2013, 0, 3, 0, 0, 0));
                    expect(+xs.data2[0]).to.equal(+new Date(2013, 0, 1, 0, 0, 0));
                    expect(+xs.data2[1]).to.equal(+new Date(2013, 0, 2, 0, 0, 0));
                    expect(+xs.data2[2]).to.equal(+new Date(2013, 0, 3, 0, 0, 0));
                });
            });
        ...
        describe('milliseconds timeseries x', function () {
            ...
            describe('as date string', function () {
                ...
                it('should have correct number of xs', function () {
                    expect(Object.keys(chart.internal.data.xs).length).to.equal(2);
                    expect(chart.internal.data.xs.data1.length).to.equal(2);
                    expect(chart.internal.data.xs.data2.length).to.equal(2);
                });

                it('should have Date object as x', function () {
                    var xs = chart.internal.data.xs;
                    expect(+xs.data1[0]).to.equal(+new Date(2014, 4, 20, 17, 25, 0, 123));
                    expect(+xs.data1[1]).to.equal(+new Date(2014, 4, 20, 17, 30, 0, 345));
                    expect(+xs.data2[0]).to.equal(+new Date(2014, 4, 20, 17, 25, 0, 123));
                    expect(+xs.data2[1]).to.equal(+new Date(2014, 4, 20, 17, 30, 0, 345));
                });
                ...
                it('should have milliseconds tick format', function () {
                    ...
                    chart.internal.main.selectAll('.c3-axis-x g.tick text').each(function (d, i) {
                        expect(d3.select(this).text()).to.equal(expected[i]);
                    });
                });
            ...
            describe('as unixtime number', function () {
                ...
                it('should have Date object as x', function () {
                    var xs = chart.internal.data.xs;
                    expect(+xs.data1[0]).to.equal(1417622461123);
                    expect(+xs.data1[1]).to.equal(1417622522345);
                    expect(+xs.data2[0]).to.equal(1417622461123);
                    expect(+xs.data2[1]).to.equal(1417622522345);
                });
            });
