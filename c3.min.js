(function(P){function ld(){function u(d,f){d.attr("transform",function(d){return"translate("+(f(d)+ca)+", 0)"})}function x(d,f){d.attr("transform",function(d){return"translate(0,"+f(d)+")"})}function P(d){var f=d[0];d=d[d.length-1];return f<d?[f,d]:[d,f]}function Ea(d){for(var f=[],n=Math.ceil(d[0]);n<d[1];n++)f.push(n);0<f.length&&0<f[0]&&f.unshift(f[0]-(f[1]-f[0]));return f}function Fa(d){d=d<da.length?da[d]:d;return N?N(d):d}function q(q){q.each(function(){var q=d.select(this),ia=Ea(n.domain()),
R=q.selectAll(".tick.major").data(ia,String),S=R.enter().insert("g","path").attr("class","tick major").style("opacity",1E-6),T=d.transition(R.exit()).style("opacity",1E-6).remove(),w=d.transition(R).style("opacity",1),G,N=n.rangeExtent?n.rangeExtent():P(n.range()),q=q.selectAll(".domain").data([0]);q.enter().append("path").attr("class","domain");var q=d.transition(q),y=n.copy(),da=this.__chart__||y;this.__chart__=y;S.append("line");S.append("text");var ja=S.select("line"),Wa=w.select("line"),ka=R.select("text"),
Xa=S.select("text"),Ya=w.select("text");ca=(y(1)-y(0))/2;R=ra?0:ca;switch(A){case "bottom":G=u;ja.attr("y2",O);Xa.attr("y",Math.max(O,0)+f);Wa.attr("x1",R).attr("x2",R).attr("y2",O);Ya.attr("x",0).attr("y",Math.max(O,0)+f);ka.attr("dy",".71em").style("text-anchor","middle");ka.text(function(d){return ia.length<X||0===d%Math.ceil(ia.length/X)?Fa(d):""});q.attr("d","M"+N[0]+","+Y+"V0H"+N[1]+"V"+Y);break;case "left":G=x,ja.attr("x2",-O),Xa.attr("x",-(Math.max(O,0)+f)),Wa.attr("x2",-O).attr("y2",0),Ya.attr("x",
-(Math.max(O,0)+f)).attr("y",ca),ka.attr("dy",".32em").style("text-anchor","end"),ka.text(function(d){return ia.length<X||0===d%Math.ceil(ia.length/X)?Fa(d):""}),q.attr("d","M"+-Y+","+N[0]+"H0V"+N[1]+"H"+-Y)}if(n.ticks)S.call(G,da),w.call(G,y),T.call(G,y);else{var Za=y.rangeBand()/2,T=function(d){return y(d)+Za};S.call(G,T);w.call(G,T)}})}var n=d.scale.linear(),A="bottom",O=6,Y=6,f=3,ra=!1,X=10,ca=0,N=null,da=[];q.scale=function(d){if(!arguments.length)return n;n=d;return q};q.orient=function(d){if(!arguments.length)return A;
A=d in{top:1,right:1,bottom:1,left:1}?d+"":"bottom";return q};q.categories=function(d){if(!arguments.length)return da;da=d;return q};q.tickCentered=function(d){if(!arguments.length)return ra;ra=d;return q};q.tickTextNum=function(d){if(!arguments.length)return X;X=d;return q};q.tickFormat=function(d){if(!arguments.length)return N;N=d;return q};q.tickOffset=function(){return ca};q.ticks=function(){};return q}function x(d){return"undefined"===typeof d}function u(d){return"undefined"!==typeof d}var yb=
P.c3={},d=P.d3;yb.generate=function(ba){var ic,jc,Ea,Fa,q,n,A,O,Y;function f(a,b){for(var c=ba,e=0;e<a.length;e++){if(!(a[e]in c))return b;c=c[a[e]]}return c}function ra(){zb=null===$a?ca():$a;sa=X();n=0;A=(g?Ab+mc:0)+(ab?ab:bb?1:40);O=20+(g?0:Ab)+la;Y=cb?cb:Bb?db||g?1:40:20;r=zb-A-Y;s=sa-n-O;Ea=g?n:sa-Ab-la;Fa=g?nc:A;q=20+la;Cb=g?A-nc-mc:r;eb=g?s:sa-Ea-q;ic=sa-la;jc=A;Db=s/2;Ga=0.95*Db;Eb=ma(h.data.targets,"dount")?0.6*Ga:0}function X(){var a=null===oc?+d.select(ta).style("height").replace("px",
""):oc;return 0<a?a:320}function ca(){return+d.select(ta).style("width").replace("px","")}function N(){return r+2+A+Y}function da(){return 40}function ia(){return A+20}function yb(){return s-n+2}function md(){var a=g?s:r,b=ua(U)/ua(m.domain()),c=fb();return 1<c?a*b/(c-1):a}function R(){Fb=g?1:0;Gb=g?s:r;Hb=g?0:s;Ib=g?r:1;Jb=g?0:eb;Kb=g?Cb:1;m=S(Fb,Gb,u(m)?m.domain():void 0,function(){return J.tickOffset()});z=T(Hb,Ib,u(z)?z.domain():void 0);Z=T(Hb,Ib,u(Z)?Z.domain():void 0);V=S(Fb,Gb,u(U)?U:void 0,
...
c=W.property("offsetWidth"),e=W.property("offsetHeight"),g?d=b[0]:(k=p.property("offsetLeft"),d=k+(ab?ab:bb?1:40)+m(a[0].x)+20,f=d+c,k=k+(null===$a?ca():$a)-(cb?cb:Bb?db||g?1:40:20),f>k&&(d-=c+30)),c=b[1]+15+e<X()?b[1]+15:b[1]-e,W.style("top",c+"px").style("left",d+"px").style("visibility","visible"))}function Pc(a){ma(h.data.targets,"scatter")||D(h.data.targets)||l.selectAll("line.xgrid-focus").style("visibility","visible").data([a]).attr(g?"y1":"x1",wa).attr(g?"y2":"x2",wa)}function Qc(){l.select("line.xgrid-focus").style("visibility",
...
l).selectAll(".-circle"+(a||0===a?"-"+a:""))}function Ub(a){Tb(a).filter(function(){return d.select(this).classed(aa)}).classed(aa,!1).attr("r",Vb)}function $c(a){return l.selectAll(".-bar"+(a||0===a?"-"+a:""))}function ae(a,b,c,e){var d,f,h="M",l,m,za,p,q,n=[];if(u(e))for(d=0;d<e.length;d++)n[d]={},x(e[d].start)?n[d].start=a[0].x:n[d].start=B?na(e[d].start):e[d].start,x(e[d].end)?n[d].end=a[a.length-1].x:n[d].end=B?na(e[d].end):e[d].end;p=g?function(a){return c(a.value)}:function(a){return b(a.x)};
q=g?function(a){return b(a.x)}:function(a){return c(a.value)};e=B?function(a,e,d,k){var f=a.x.getTime();a=e.x-a.x;e=new Date(f+a*(d+k));return"M"+b(new Date(f+a*d))+" "+c(m(d))+" "+b(e)+" "+c(m(d+k))}:function(a,e,d,k){return"M"+b(l(d))+" "+c(m(d))+" "+b(l(d+k))+" "+c(m(d+k))};for(d=0;d<a.length;d++)if(x(n)||!Xd(a[d].x,n))h+=" "+p(a[d])+" "+q(a[d]);else{l=S(a[d-1].x,a[d].x);m=T(a[d-1].value,a[d].value);f=b(a[d].x)-b(a[d-1].x);za=c(a[d].value)-c(a[d-1].value);f=Math.sqrt(Math.pow(f,2)+Math.pow(za,
2));za=2/f;var r=2*za;for(f=za;1>=f;f+=r)h+=e(a[d-1],a[d],f,za)}return h}function Wb(a){var b;tb=d.select(ta);if(tb.empty())P.alert('No bind element found. Check the selector specified by "bindto" and existance of that element. Default "bindto" is "#chart".');else{tb.html("");h.data.x={};h.data.targets=La(a);ra();R();m.domain(d.extent(ob(h.data.targets)));z.domain(mb("y"));Z.domain(mb("y2"));V.domain(m.domain());hb.domain(z.domain());ib.domain(Z.domain());J.ticks(10>a.length?a.length:10);va.ticks(be).outerTickSize(0).tickFormat(ce);
jb.ticks(de).outerTickSize(0).tickFormat(ee);U=m.domain();L.scale(V);pa&&E.scale(m);p=d.select(ta).append("svg").attr("width",r+A+Y).attr("height",s+n+O).on("mouseenter",fe).on("mouseleave",ge);ub=p.append("defs");ub.append("clipPath").attr("id",Xb).append("rect").attr("y",n).attr("width",r).attr("height",s-n);ub.append("clipPath").attr("id","xaxis-clip").append("rect").attr("x",-1-A).attr("y",-20).attr("width",N).attr("height",da);ub.append("clipPath").attr("id","yaxis-clip").append("rect").attr("x",
-A+1).attr("y",n-1).attr("width",ia).attr("height",yb);l=p.append("g").attr("transform",M.main);F=Aa?p.append("g").attr("transform",M.context):null;Ba=Ca?p.append("g").attr("transform",M.legend):null;W=d.select(ta).style("position","relative").append("div").style("position","absolute").style("z-index","10").style("display","none");l.append("g").attr("class","x axis").attr("clip-path",g?"":"url(#xaxis-clip)").attr("transform",M.x).call(g?va:J).append("text").attr("class","-axis-x-label").attr("x",
r).attr("dy","-.5em").style("text-anchor","end").text(he);l.append("g").attr("class","y axis").attr("clip-path",g?"url(#yaxis-clip)":"").call(g?J:va).append("text").attr("transform","rotate(-90)").attr("dy","1.2em").attr("dx","-.5em").style("text-anchor","end").text(ie);Bb&&l.append("g").attr("class","y2 axis").attr("transform",M.y2).call(jb);a=l.append("g").attr("clip-path",Ra).attr("class","grid");ad&&a.append("g").attr("class","xgrids");Yb&&(b=a.append("g").attr("class","xgrid-lines").selectAll(".xgrid-line").data(Yb).enter().append("g").attr("class",
...
l.select(".x.axis .-axis-x-label").attr("x",r);hb.domain(z.domain());ib.domain(Z.domain());W.style("display","none");l.select("line.xgrid-focus").style("visibility","hidden").attr("y2",s);if(ad){if("year"===re)for(b=[],a=ob(),t=a[0].getFullYear(),a=a[1].getFullYear();t<=a;t++)b.push(new Date(t+"-01-01 00:00:00"));else b=m.ticks(10);b=l.select(".xgrids").selectAll(".xgrid").data(b);b.enter().append("line").attr("class","xgrid");b.attr("x1",g?0:function(a){return m(a)-J.tickOffset()}).attr("x2",g?r:
function(a){return m(a)-J.tickOffset()}).attr("y1",g?function(a){return m(a)-J.tickOffset()}:n).attr("y2",g?function(a){return m(a)-J.tickOffset()}:s).style("opacity",function(){return+d.select(this).attr(g?"y1":"x1")===(g?s:0)?0:1});b.exit().remove()}Yb&&(b=l.selectAll(".xgrid-lines"),b.selectAll("line").transition().duration(v).attr("x1",g?0:Oa).attr("x2",g?r:Oa).attr("y1",g?Oa:n).attr("y2",g?Oa:s),b.selectAll("text").attr("x",g?r:0).attr("y",Oa));c&&bd&&(b=l.select(".ygrids").selectAll(".ygrid").data(z.ticks(10)),
b.enter().append("line").attr("class","ygrid"),b.attr("x1",g?z:0).attr("x2",g?z:r).attr("y1",g?0:z).attr("y2",g?s:z),b.exit().remove());c&&Zb&&(c=l.select(".ygrid-lines"),c.selectAll("line").transition().duration(v).attr("x1",g?Pa:0).attr("x2",g?Pa:r).attr("y1",g?0:Pa).attr("y2",g?s:Pa),c.selectAll("text").attr("x",g?0:r).attr("y",Pa));c=function(a){var b=ea?p?1.2*J.tickOffset()/p:0:0.6*((g?s:r)*(a?1:ua(U)/ua(m.domain()))/(fb()-1)),c=Td(b,p,f,!!a),e=Ud(!!a),d=Vd(f,!!a),h=a?G:w;return function(a,f){var k=
...
function(a){return K(a.id)}));Ca&&wb(a);p.selectAll(".target").transition().style("opacity",1)}function Ta(a,b){h.data.targets.forEach(function(b){for(var e=0;e<a.length;e++)if(b.id===a[e].id){b.values=a[e].values;a.splice(e,1);break}});h.data.targets=h.data.targets.concat(a);cd(h.data.targets);I({withUpdateOrgXDomain:!0,withUpdateXDomain:!0});b()}function ec(a){var b=p.selectAll(".legend-item"),c=function(b){return!a||b===a};b.filter(function(a){return!c(a)}).transition().duration(100).style("opacity",
0.3);b.filter(c).transition().duration(100).style("opacity",1)}function we(a){var b=p.selectAll(".legend-item"),c=function(b){return!a||b===a};b.filter(function(a){return!c(a)}).transition().duration(100).style("opacity",1);b.filter(c).transition().duration(100).style("opacity",0.3)}function fc(){p.selectAll(".legend-item").transition().duration(100).style("opacity",1)}function wb(a,b){var c=rb(a),e,d=r/2-Ua*Object.keys(a).length/2,f;b=x(b)?{}:b;f=u(b.withTransition)?b.withTransition:!0;e=Ba.selectAll(".legend-item").data(c).enter().append("g").attr("class",
function(a){return"legend-item legend-item-"+a}).style("cursor","pointer").on("click",function(a){xe(a)}).on("mouseover",function(a){ec(a);h.focus(a)}).on("mouseout",function(){fc();h.revert()});e.append("rect").attr("class","legend-item-event").style("fill-opacity",0).attr("x",-200).attr("y",function(){return la/2-16}).attr("width",Ua).attr("height",24);e.append("rect").attr("class","legend-item-tile").style("pointer-events","none").style("fill",function(a){return K(a)}).attr("x",-200).attr("y",
function(){return la/2-9}).attr("width",10).attr("height",10);e.append("text").text(function(a){return u(Ka[a])?Ka[a]:a}).style("pointer-events","none").attr("x",-200).attr("y",function(){return la/2});Ba.selectAll("rect.legend-item-event").data(c).transition().duration(f?250:0).attr("x",function(a,b){return d+Ua*b});Ba.selectAll("rect.legend-item-tile").data(c).transition().duration(f?250:0).attr("x",function(a,b){return d+Ua*b});Ba.selectAll("text").data(c).transition().duration(f?250:0).attr("x",
function(a,b){return d+Ua*b+14})}function Va(a){return u(a)?".target-"+a:".target"}function gc(a){return Bc(a.id)}function hc(a){return"data"in a&&Bc(a.data.id)}var h={data:{}},pb={},aa="_expanded_",ha="_selected_",dc="_included_",ta=f(["bindto"],"#chart"),$a=f(["size","width"],null),oc=f(["size","height"],null),ab=f(["padding","left"],null),cb=f(["padding","right"],null),pa=f(["zoom","enabled"],!1),id=f(["zoom","extent"],null),ke=f(["zoom","privileged"],!1),fe=f(["onenter"],function(){}),ge=f(["onleave"],
function(){});if(!("data"in ba))throw Error("data is required in config");var oa=f(["data","x"],null),$=f(["data","xs"],null),Qb=f(["data","x_format"],"%Y-%m-%d"),Kd=f(["data","id_converter"],function(a){return a}),Ka=f(["data","names"],{}),t=f(["data","groups"],[]),rc=f(["data","axes"],{}),zc=f(["data","type"],null),C=f(["data","types"],{}),jd=f(["data","regions"],{}),ye=f(["data","colors"],{}),fa=f(["data","selection","enabled"],!1),qa=f(["data","selection","grouped"],!1),ga=f(["data","selection",
"isselectable"],function(){return!0}),Aa=f(["subchart","show"],!1),Ab=Aa?f(["subchart","size","height"],60):0,ze=f(["color","pattern"],null),Ca=f(["legend","show"],!0),Ua=f(["legend","item","width"],80),xe=f(["legend","item","onclick"],function(){}),kd=f(["axis","x","type"],"indexed"),Ha=f(["axis","x","categories"],[]),rd=f(["axis","x","tick","centered"],!1),lb=f(["axis","x","tick","format"],null),vb=f(["axis","x","default"],null),he=f(["axis","x","label"],null),Ad=f(["axis","y","max"],null),yd=f(["axis",
"y","min"],null),Cd=f(["axis","y","center"],null),ie=f(["axis","y","label"],null),bb=f(["axis","y","inner"],!1),ce=f(["axis","y","tick","format"],function(a){return a}),Ia=f(["axis","y","padding"],null),be=f(["axis","y","ticks"],10),Bb=f(["axis","y2","show"],!1),zd=f(["axis","y2","max"],null),xd=f(["axis","y2","min"],null),Bd=f(["axis","y2","center"],null),db=f(["axis","y2","inner"],!1),ee=f(["axis","y2","tick","format"],function(a){return a}),Ja=f(["axis","y2","padding"],null),de=f(["axis","y2",
"ticks"],10),g=f(["axis","rotated"],!1),ad=f(["grid","x","show"],!1),re=f(["grid","x","type"],"tick"),Yb=f(["grid","x","lines"],null),bd=f(["grid","y","show"],!1),Zb=f(["grid","y","lines"],null),Vb=f(["point","show"],!0)?f(["point","r"],2.5):0,je=f(["point","focus","line","enabled"],!0),$b=f(["point","focus","expand","enabled"],!0),ac=f(["point","focus","expand","r"],$b?4:Vb),Qa=f(["point","focus","select","r"],8),qe=f(["point","onclick"],function(){}),Yd=f(["point","onselected"],function(){}),Zd=
f(["point","onunselected"],function(){}),Q=f(["regions"],[]),Oc=f(["tooltip","contents"],function(a){var b="<table class='-tooltip'><tr><th colspan='2'>"+lc()(a[0].x)+"</th></tr>",c,d,f;for(c=0;c<a.length;c++)a[c]&&(a[c].value||0===a[c].value)&&(d=u(a[c].value)?(Math.round(100*a[c].value)/100).toFixed(2):"-",f=a[c].name,b+="<tr class='-tooltip-name-"+a[c].id+"'><td class='name'><span style='background-color:"+K(a[c].id)+"'></span>"+f+"</td><td class='value'>"+d+"</td></tr>");return b+"</table>"}),
le=f(["tooltip","init","show"],!1),Da=f(["tooltip","init","x"],0),dd=f(["tooltip","init","position"],{top:"0px",left:"50px"}),Xb=ta.replace("#","")+"-clip",Ra="url(#"+Xb+")",B="timeseries"===kd,ea="categorized"===kd,Nb=!B&&(oa||$),cc=null,Sa=!1,bc=!1,la=Ca?40:0,K=function(a,b){var c=[],d=null!==b?b:"#1f77b4 #ff7f0e #2ca02c #d62728 #9467bd #8c564b #e377c2 #7f7f7f #bcbd22 #17becf".split(" ");return function(b){if(b in a)return a[b];-1===c.indexOf(b)&&c.push(b);return d[c.indexOf(b)%d.length]}}(ye,ze),
sd=function(){var a=[[d.time.format("%Y/%-m/%-d"),function(){return!0}],[d.time.format("%-m/%-d"),function(a){return a.getMonth()}],[d.time.format("%-m/%-d"),function(a){return 1!==a.getDate()}],[d.time.format("%-m/%-d"),function(a){return a.getDay()&&1!==a.getDate()}],[d.time.format("%I %p"),function(a){return a.getHours()}],[d.time.format("%I:%M"),function(a){return a.getMinutes()}],[d.time.format(":%S"),function(a){return a.getSeconds()}],[d.time.format(".%L"),function(a){return a.getMilliseconds()}]];
return function(b){for(var c=a.length-1,d=a[c];!d[1](b);)d=a[--c];return d[0](b)}}(),r,Cb,s,eb,zb,sa,Ga,Db,Eb,kb,pc,qc,Lb,Fb,Gb,Hb,Ib,Jb,Kb,m,z,Z,V,hb,ib,J,va,jb,gb,nd=g?"left":"bottom",od=g?bb?"top":"bottom":bb?"right":"left",pd=g?db?"bottom":"top":db?"left":"right",qd=g?"left":"bottom",M={main:function(){return"translate("+A+","+n+")"},context:function(){return"translate("+Fa+","+Ea+")"},legend:function(){return"translate("+jc+","+ic+")"},y2:function(){return"translate("+(g?0:r)+","+(g?10:0)+")"},
x:function(){return"translate(0,"+s+")"},subx:function(){return"translate(0,"+(g?0:eb)+")"},arc:function(){return"translate("+r/2+","+s/2+")"}},nc=40,mc=20;Lb=d.layout.pie().value(function(a){return a.values.reduce(function(a,c){return a+c.value},0)});var se=function(){var a=d.svg.line().x(g?function(a){return w(a.id)(a.value)}:wa).y(g?wa:function(a){return w(a.id)(a.value)});return function(b){var c=Sb(b.values),d;if(Pb(b))return Rc(b)?a.interpolate("cardinal"):a.interpolate("linear"),jd[b.id]?ae(c,
...
"M "+b+" "+d:"M "+d+" "+b}}(),ue=function(){var a=d.svg.line().x(g?function(a){return G(a.id)(a.value)}:Ic).y(g?Ic:function(a){return G(a.id)(a.value)});return function(b){var c=Sb(b.values);return Pb(b)?a(c):"M "+V(c[0].x)+" "+G(b.id)(c[0].value)}}(),L=d.svg.brush().on("brush",function(){I({withTransition:!1,withY:!1,withSubchart:!1,withUpdateXDomain:!0})}),E=d.behavior.zoom().on("zoomstart",function(){E.altDomain=d.event.sourceEvent.altKey?m.orgDomain():null}).on("zoom",pa?ve:null);L.update=function(){F&&
F.select(".x.brush").call(this);return this};L.scale=function(a){return g?this.y(a):this.x(a)};E.scale=function(a){return g?this.y(a):this.x(a)};E.orgScaleExtent=function(){var a=id?id:[1,10];return[a[0],Math.max(fb()/a[1],a[1])]};E.updateScaleExtent=function(){var a=ua(m.orgDomain())/ua(U),b=this.orgScaleExtent();this.scaleExtent([b[0]*a,b[1]*a]);return this};var p,ub,l,F,Ba,W,tb,U;h.focus=function(a){var b=p.selectAll(Va(a)),c=b.filter(gc),b=b.filter(hc);h.revert();h.defocus();c.classed("focused",
!0).transition().duration(100).style("opacity",1);b.transition().duration(100).style("opacity",1);D(h.data.targets)&&Za(a,!0);ec(a)};h.defocus=function(a){var b=p.selectAll(Va(a)),c=b.filter(gc),b=b.filter(hc);h.revert();c.classed("focused",!1).transition().duration(100).style("opacity",0.3);b.transition().duration(100).style("opacity",0.3);D(h.data.targets)&&xb(a);we(a)};h.revert=function(a){var b=p.selectAll(Va(a)),c=b.filter(gc),b=b.filter(hc);c.classed("focused",!1).transition().duration(100).style("opacity",
1);b.transition().duration(100).style("opacity",1);D(h.data.targets)&&xb(a);fc()};h.show=function(a){p.selectAll(Va(a)).transition().style("opacity",1)};h.hide=function(a){p.selectAll(Va(a)).transition().style("opacity",0)};h.unzoom=function(){L.clear().update();I({withUpdateXDomain:!0})};h.load=function(a){"function"!==typeof a.done&&(a.done=function(){});a.xs&&Jd(a.xs);"categories"in a&&ea&&(Ha=a.categories,J.categories(Ha));if("cacheIds"in a&&Fd(a.cacheIds))Ta(Gd(a.cacheIds),a.done);else if("data"in
