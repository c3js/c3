...
a).selectAll(".-shape").filter(function(){return e.select(this).classed(na)}).map(function(a){return a.map(function(a){return a.__data__})}))};k.select=function(a,b,c){la&&l.selectAll(".-shapes").selectAll(".-shape").each(function(d,f){var g="circle"===this.nodeName?fd:re,h="circle"===this.nodeName?Yb:hd;0<=b.indexOf(f)?ma(d)&&(wa||x(a)||0<=a.indexOf(d.id))&&g(e.select(this).classed(na,!0),d,f):y(c)&&c&&h(e.select(this).classed(na,!1),d,f)})};k.unselect=function(a,b){la&&l.selectAll(".-shapes").selectAll(".-shape").each(function(c,
