...
function Ac(){var a={},c=0,d,b;Ta(Aa).forEach(function(f){for(d=0;d<q.length;d++)if(!(0>q[d].indexOf(f.id)))for(b=0;b<q[d].length;b++)if(q[d][b]in a){a[f.id]=a[q[d][b]];break}u(a[f.id])&&(a[f.id]=c++)});a.__max__=c-1;return a}function Qb(a,c,d,b){var f=b?V:m;return function(b){var n=b.id in d?d[b.id]:0;return f(b.x)-a*(c/2-n)}}function Rb(a,c,d,b){var f=Object.keys(c);return function(e,p){var g=0,k=b?Na(e.id):h(e.id);Ta(Aa).forEach(function(d){d.id!==e.id&&c[d.id]===c[e.id]&&f.indexOf(d.id)<f.indexOf(e.id)&&
(g+=a(d.values[p]))});return d?g:k(e.value)-g}}function Sb(a,c){var d=null===a?function(a){return a}:function(c){return a-c};return function(a){var b=c?Na(a.id):h(a.id);return d(b(a.value))}}function lb(a,c){var d=u(a)?ib():a;"string"===typeof d&&(d=[d]);for(var b=0;b<d.length;b++)Y[d[b]]=c}function vc(a,c){var d=!1;a.forEach(function(a){Y[a.id]===c&&(d=!0);a.id in Y||"line"!==c||(d=!0)});return d}function mb(a){a="string"===typeof a?a:a.id;return!(a in Y)||"line"===Y[a]||"spline"===Y[a]}function Aa(a){return"bar"===
...
x.domain(B(c,"y"));O.domain(B(c,"y2"));V.domain(m.domain());Qa.domain(x.domain());Ra.domain(O.domain());M.ticks(10>a.length?a.length:10);ga.ticks(Hc).outerTickSize(0).tickFormat(Ic);Sa.ticks(Jc).outerTickSize(0).tickFormat(Kc);P=m.domain();E.x(V);ja&&F.x(m);Ha=d3.select(ya).append("svg").attr("width",t+H+C).attr("height",s+v+U);Ya=Ha.append("defs");Ya.append("clipPath").attr("id",pb).append("rect").attr("y",v).attr("width",t).attr("height",s-v);Ya.append("clipPath").attr("id","xaxis-clip").append("rect").attr("x",
...
"x axis").attr("clip-path",e?"":"url(#xaxis-clip)").attr("transform",I.x).call(e?ga:M);g.append("g").attr("class","y axis").attr("clip-path",e?"url(#yaxis-clip)":"").call(e?M:ga).append("text").attr("transform","rotate(-90)").attr("dy","1.4em").attr("dx","-.8em").style("text-anchor","end").text(Lc);Fb&&g.append("g").attr("class","y2 axis").attr("transform",I.y2).call(Sa);if(ja)g.append("rect").attr("class","zoom-rect").attr("width",t).attr("height",s).style("opacity",0).style("cursor","ew-resize").call(F).on("dblclick.zoom",
...
250:0).attr("x",function(a,c){return f+La*c});ra.selectAll("rect.legend-item-tile").data(b).transition().duration(g?250:0).attr("x",function(a,c){return f+La*c});ra.selectAll("text").data(b).transition().duration(g?250:0).attr("x",function(a,c){return f+La*c+14})}function Ma(a){return l(a)?".target-"+a:".target"}var k={data:{}},Ua={},aa="_expanded_",ba="_selected_",vb="_included_",ya=b(["bindto"],"#chart"),Ab=b(["size","width"],null),Bb=b(["size","height"],null),ja=b(["zoom","enabled"],!1);if(!("data"in
R))throw Error("data is required in config");var Va=b(["data","x"],"x"),Uc=b(["data","x_format"],"%Y-%m-%d"),wc=b(["data","id_converter"],function(a){return a}),Da=b(["data","names"],{}),q=b(["data","groups"],[]),Lb=b(["data","axes"],{}),Y=b(["data","types"],{}),gc=b(["data","regions"],{}),Vc=b(["data","colors"],{}),$=b(["data","selection","enabled"],!1),ka=b(["data","selection","grouped"],!1),la=b(["data","selection","isselectable"],function(a){return!0}),qa=b(["subchart","show"],!1),Db=qa?b(["subchart",
"size","height"],60):0,Wc=b(["color","pattern"],null),sa=b(["legend","show"],!0),La=b(["legend","item","width"],80),Tc=b(["legend","item","onclick"],function(){}),hc=b(["axis","x","type"],"indexed"),gb=b(["axis","x","categories"],[]),oc=b(["axis","x","tick","centered"],!1),Ja=b(["axis","x","default"],null),sc=b(["axis","y","max"],null),qc=b(["axis","y","min"],null),uc=b(["axis","y","center"],null),Lc=b(["axis","y","text"],null);b(["axis","y","rescale"],!0);var db=b(["axis","y","inner"],!1),Ic=b(["axis",
"y","format"],function(a){return a}),Ba=b(["axis","y","padding"],null),Hc=b(["axis","y","ticks"],10),Fb=b(["axis","y2","show"],!1),rc=b(["axis","y2","max"],null),pc=b(["axis","y2","min"],null),tc=b(["axis","y2","center"],null);b(["axis","y2","text"],null);b(["axis","y2","rescale"],!0);var cb=b(["axis","y2","inner"],!1),Kc=b(["axis","y2","format"],function(a){return a}),Ca=b(["axis","y2","padding"],null),Jc=b(["axis","y2","ticks"],10),e=b(["axis","rotated"],!1),$b=b(["grid","x","show"],!1),Pc=b(["grid",
"x","type"],"tick"),qb=b(["grid","x","lines"],null),ac=b(["grid","y","show"],!1);b(["grid","y","type"],"tick");var rb=b(["grid","y","lines"],null),sb=b(["point","show"],!0)?b(["point","r"],2.5):0,Mc=b(["point","focus","line","enabled"],!0),bc=b(["point","focus","expand","enabled"],!0),cc=b(["point","focus","expand","r"],bc?4:sb),Ga=b(["point","focus","select","r"],8),Nc=b(["point","onclick"],function(){}),Dc=b(["point","onselected"],function(){}),Ec=b(["point","onunselected"],function(){}),J=b(["regions"],
[]),dc=b(["tooltip","contents"],function(a){var c="<table class='-tooltip'><tr><th colspan='2'>"+(D?a[0].x.getFullYear()+"."+(a[0].x.getMonth()+1)+"."+a[0].x.getDate():ha?a[0].x<gb.length?gb[a[0].x]:a[0].x:a[0].x)+"</th></tr>",b,e,f;for(b=0;b<a.length;b++)l(a[b])?(e=l(a[b].value)?(Math.round(100*a[b].value)/100).toFixed(2):"-",f=a[b].name):f=e="-",c+="<tr><td><span style='background-color:"+Q(a[b].id)+"'></span>"+f+"</td><td class='value'>"+e+"</td></tr>";return c+"</table>"}),Oc=b(["tooltip","init",
"show"],!1),ta=b(["tooltip","init","x"],0),fc=b(["tooltip","init","position"],{top:"0px",left:"50px"}),pb=ya.replace("#","")+"-clip",Ia="url(#"+pb+")",D="timeseries"===hc,ha="categorized"===hc,ub=null,Za=!1,tb=!1,ea=sa?40:0,ia=d3.time.format(Uc).parse,Q=function(a,c){var b=[],e=null!==c?c:"#1f77b4 #ff7f0e #2ca02c #d62728 #9467bd #8c564b #e377c2 #7f7f7f #bcbd22 #17becf".split(" ");return function(c){if(c in a)return a[c];0<=b.indexOf(c)||b.push(c);return e[b.indexOf(c)%e.length]}}(Vc,Wc),nc=function(){var a=
[[d3.time.format("%Y/%-m/%-d"),function(){return!0}],[d3.time.format("%-m/%-d"),function(a){return a.getMonth()}],[d3.time.format("%-m/%-d"),function(a){return 1!=a.getDate()}],[d3.time.format("%-m/%-d"),function(a){return a.getDay()&&1!=a.getDate()}],[d3.time.format("%I %p"),function(a){return a.getHours()}],[d3.time.format("%I:%M"),function(a){return a.getMinutes()}],[d3.time.format(":%S"),function(a){return a.getSeconds()}],[d3.time.format(".%L"),function(a){return a.getMilliseconds()}]];return function(c){for(var b=
a.length-1,e=a[b];!e[1](c);)e=a[--b];return e[0](c)}}(),Cb,Hb,Eb,Pa,Gb,Ib,t,s,fa,bb,pa,Jb,Kb,eb,fb,m,x,O,V,Qa,Ra,M,ga,Sa,za,jc=e?"left":"bottom",kc=e?db?"top":"bottom":db?"right":"left",lc=e?cb?"bottom":"top":cb?"left":"right",mc="bottom",I={main:function(){return"translate("+H+","+v+")"},context:function(){return"translate("+G+","+ua+")"},legend:function(){return"translate("+Oa+","+xb+")"},y2:function(){return"translate("+(e?0:t)+","+(e?10:0)+")"},x:function(){return"translate(0,"+s+")"},subx:function(){return"translate(0,"+
fa+")"}},Qc=function(){var a=d3.svg.line().x(e?function(a){return h(a.id)(a.value)}:Xa).y(e?Xa:function(a){return h(a.id)(a.value)});return function(c){var b;if(mb(c))return"spline"===Y["string"===typeof c?c:c.id]?a.interpolate("cardinal"):a.interpolate("linear"),0<Object.keys(gc).length?Gc(c.values,m,h(c.id),gc[c.id]):a(c.values);b=m(c.values[0].x);c=h(c.id)(c.values[0].value);return e?"M "+c+" "+b:"M "+b+" "+c}}(),Rc=function(){var a=d3.svg.line().x(function(a){return V(a.x)}).y(function(a){return Na(a.id)(a.value)});
return function(c){return mb(c)?a(c.values):"M "+V(c.values[0].x)+" "+Na(c.id)(c.values[0].value)}}(),E=d3.svg.brush().on("brush",function(){z({withTransition:!1,withY:!1,withSubchart:!1,withUpdateXDomain:!0})}),F=d3.behavior.zoom().on("zoomstart",function(){F.altDomain=d3.event.sourceEvent.altKey?m.orgDomain():null}).on("zoom",ja?Sc:null);E.update=function(){w&&w.select(".x.brush").call(this);return this};F.orgScaleExtent=function(){return[1,Math.max(Ea()/10,10)]};F.updateScaleExtent=function(){var a=
m.orgDomain(),a=(a[1]-a[0])/(P[1]-P[0]),c=this.orgScaleExtent();this.scaleExtent([c[0]*a,c[1]*a]);return this};var Ha,Ya,g,w,ra,Z,Wa=null,hb=null,P;k.focus=function(a){k.defocus();d3.selectAll(Ma(a)).filter(function(a){return jb(a.id)}).classed("focused",!0).transition().duration(100).style("opacity",1)};k.defocus=function(a){d3.selectAll(Ma(a)).filter(function(a){return jb(a.id)}).classed("focused",!1).transition().duration(100).style("opacity",0.3)};k.revert=function(a){d3.selectAll(Ma(a)).filter(function(a){return jb(a.id)}).classed("focused",
...
k.select=function(a,c,b){$&&g.selectAll(".-shapes").selectAll(".-shape").each(function(e,f){var g="circle"===this.nodeName?Wb:Fc,h="circle"===this.nodeName?nb:Yb;0<=c.indexOf(f)?la(e)&&(ka||u(a)||0<=a.indexOf(e.id))&&g(d3.select(this).classed(ba,!0),e,f):l(b)&&b&&h(d3.select(this).classed(ba,!1),e,f)})};k.unselect=function(a,c){$&&g.selectAll(".-shapes").selectAll(".-shape").each(function(b,e){var f="circle"===this.nodeName?nb:Yb;(u(c)||0<=c.indexOf(e))&&la(b)&&(ka||u(a)||0<=a.indexOf(b.id))&&f(d3.select(this).classed(ba,
