...
b){for(var d=T,h=0;h<a.length;h++){if(!(a[h]in d))return b;d=d[a[h]]}return d}function P(){gb=null===Eb?+e.select(ta).style("width").replace("px",""):Eb;var a=null===Fb?+e.select(ta).style("height").replace("px",""):Fb;ua=0<a?a:320;Gb=20+Hb+ha;Ib=!Jb||f||hb?1:50;Ta=ib?0:40;Kb=ua-Hb-ha;Lb=20+ha;Mb=ua-ha;w=0;D=Ib;W=Gb;I=Ta;Aa=Kb;l=Lb;H=Ta;Bb=Mb;Cb=Ta;q=gb-I-D;t=ua-w-W;ia=ua-Aa-l}function U(){Nb=f?10:0;Ob=f?t:q;jb=f?0:t;kb=f?q:1;m=N(Nb,Ob,n(m)?m.domain():void 0,function(){return O.tickOffset()});z=x(jb,
