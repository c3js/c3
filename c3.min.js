...
for(d=0;d<r.length;d++)for(g=1;g<r[d].length;g++)ua(r[d][g])&&(u(b[r[d][g]])||b[r[d][g]].forEach(function(a,c){A(r[d][g])===A(r[d][0])&&(b[r[d][0]][c]+=1*a)}));return d3.max(Object.keys(b).map(function(a){return d3.max(b[a])}))}function E(a,b){var d=Ka(function(a){return A(a.id)===b}),g="y2"===b?ec:fc,f="y2"===b?gc:hc,g=null!==g?g:Ua(d),f=null!==f?f:dc(d),c=0.1*Math.abs(f-g),q=c,e=c,h="y2"===b?ic:jc;null!==h&&(yDomainAbs=Math.max(Math.abs(g),Math.abs(f)),f=yDomainAbs-h,g=h-yDomainAbs);"y"===b&&null!==
va&&(q=k(va.top)?va.top:c,e=k(va.bottom)?va.bottom:c);"y2"===b&&null!==wa&&(q=k(wa.top)?wa.top:c,e=k(wa.bottom)?wa.bottom:c);return[kc(d,"bar")?0:g-e,f+q]}function L(){var a,b;if(la){if(ma.empty())return 1;a=y.domain();b=ma.extent()}else a=Bb,b=m.domain();return(a[1]-a[0])/(b[1]-b[0])}function ga(a){for(var b=0;b<a.length;b++)if(!(a[b]in La))return!1;return!0}function ha(a){for(var b=[],d=0;d<a.length;d++)a[d]in La&&b.push(sa(La[a[d]]));return b}function A(a){return a in Cb?Cb[a]:"y"}function F(a){return"y2"===
...
Ma+"' must be included in data");g=ba(a[Ma]);if(null===g)throw Error("Failed to parse timeseries date in data");a.x=g}else a.x=d++;null===Na&&(Na=new Date(a.x));$a=new Date(a.x)});b=b.map(function(b,d){var g=lc(b);return{id:g,id_org:b,values:a.map(function(a){return{x:a.x,value:+a[b],id:g}})}});b.forEach(function(a){La[a.id_org]=sa(a)});return b}function sa(a){return{id:a.id,id_org:a.id_org,values:a.values.map(function(a){return{x:a.x,value:a.value,id:a.id}})}}function $(){return d3.max(l.data.targets,
function(a){return a.values.length})}function ta(a){a=u(a)?l.data.targets:a;return a.map(function(a){return a.id})}function Va(a){var b=ta(),d;for(d=0;d<b.length;d++)if(b[d]===a)return!0;return!1}function Ka(a){return k(a)?l.data.targets.filter(a):l.data.targets}function ab(a){return"-shapes -shapes-"+a.id}function Db(a){return ab(a)+" -line -line-"+a.id}function mc(a){return ab(a)+" -circles -circles-"+a.id}function Eb(a){return ab(a)+" -bars -bars-"+a.id}function nc(a,b){return"-shape -shape-"+
b+" -circle -circle-"+b}function Fb(a,b){return"-shape -shape-"+b+" -bar -bar-"+b}function oc(a,b){return"region region-"+b+" "+("classes"in a?[].concat(a.classes).join(" "):"")}function Oa(a){return m(a.x)}function ya(a){return m(H?ba(a.value):a.value)}function Gb(a){return x(a.value)}function U(a){return m(a.x)}function V(a){return F(a.id)(a.value)}function pc(){var a={},b=0,d,g;Ka(ua).forEach(function(c){for(d=0;d<r.length;d++)if(!(0>r[d].indexOf(c.id)))for(g=0;g<r[d].length;g++)if(r[d][g]in a){a[c.id]=
...
b?B(a.id):F(a.id);return d(c(a.value))}}function bb(a,b){var d=u(a)?ta():a;"string"===typeof d&&(d=[d]);for(var c=0;c<d.length;c++)W[d[c]]=b}function kc(a,b){var d=!1;a.forEach(function(a){W[a.id]===b&&(d=!0);a.id in W||"line"!==b||(d=!0)});return d}function cb(a){a="string"===typeof a?a:a.id;return!(a in W)||"line"===W[a]||"spline"===W[a]}function ua(a){return"bar"===W["string"===typeof a?a:a.id]}function qc(a){return cb(a)?a.values:[]}function Kb(a){return ua(a)?a.values:[]}function Lb(a,b){var d=
d3.mouse(a),c=d3.select(a),f=1*c.attr("cx"),c=1*c.attr("cy");return Math.sqrt(Math.pow(f-d[0],2)+Math.pow(c-d[1],2))<b}function Mb(a){var b=d3.mouse(a),d=d3.select(a);a=1*d.attr("x");var c=1*d.attr("y"),d=1*d.attr("width");return a-10<b[0]&&b[0]<a+d+10&&c-10<b[1]}function rc(a,b){var d;for(d=0;d<b.length;d++)if(b[d].start<a&&a<=b[d].end)return!0;return!1}function Nb(a,b,d){sc(a,b);h.select(".selected-circles-"+b.id).selectAll(".selected-circle-"+d).data([b]).enter().append("circle").attr("class",
function(a){return"selected-circle selected-circle-"+d}).attr("cx",e?V:U).attr("cy",e?U:V).attr("stroke",function(){return R(b.id)}).attr("r",1.4*za).transition().duration(100).attr("r",za)}function db(a,b,d){tc(a,b);h.select(".selected-circles-"+b.id).selectAll(".selected-circle-"+d).transition().duration(100).attr("r",0).remove()}function Ob(a,b,d,c){a?Nb(b,d,c):db(b,d,c)}function uc(a,b,d){}function Pb(a,b,d){}function Qb(a,b,d,c){}function vc(a,b,d,c){var f,s,q="M",h,l,m,Rb,n,p=[];if(k(c))for(f=
...
a.length;f++)if(u(p)||!rc(a[f].x,p))q+=" "+Rb(a[f])+" "+n(a[f]);else for(h=N(a[f-1].x,a[f].x),l=w(a[f-1].value,a[f].value),s=b(a[f].x)-b(a[f-1].x),m=d(a[f].value)-d(a[f-1].value),s=Math.sqrt(Math.pow(s,2)+Math.pow(m,2)),m=2/s,diffx2=2*m,s=m;1>=s;s+=diffx2)q+=c(a[f-1],a[f],s,m);return q}function eb(a){var b=l.data.targets=M(a),d,c;m.domain(d3.extent(a.map(function(a){return a.x})));x.domain(E(b,"y"));Q.domain(E(b,"y2"));y.domain(m.domain());Ha.domain(x.domain());Ia.domain(Q.domain());D.ticks(10>a.length?
a.length:10);ja.ticks(wc).outerTickSize(0).tickFormat(xc);Ja.ticks(yc).outerTickSize(0).tickFormat(zc);Bb=m.domain();Sb.x(m);h.append("g").attr("class","x axis").attr("clip-path",e?"":"url(#xaxis-clip)").attr("transform","translate(0,"+v+")").call(e?ja:D);h.append("g").attr("class","y axis").attr("clip-path",e?"url(#yaxis-clip)":"").call(e?D:ja).append("text").attr("transform","rotate(-90)").attr("dy","1.4em").attr("dx","-.8em").style("text-anchor","end").text(Ac);ub&&h.append("g").attr("class","y2 axis").attr("transform",
"translate("+(e?0:t)+","+(e?10:0)+")").call(Ja);d=h.append("g").attr("clip-path",Pa).attr("class","grid");Tb&&d.append("g").attr("class","xgrids");fb&&(c=d.append("g").attr("class","xgrid-lines").selectAll(".xgrid-line").data(fb).enter().append("g").attr("class","xgrid-line"),c.append("line").attr("class",function(a){return""+a["class"]}),c.append("text").attr("class",function(a){return""+a["class"]}).attr("text-anchor","end").attr("transform",e?"":"rotate(-90)").attr("dx",e?0:-p).attr("dy",-6).text(function(a){return a.text}));
Bc&&d.append("g").attr("class","xgrid-focus").append("line").attr("class","xgrid-focus").attr("x1",e?0:-10).attr("x2",e?t:-10).attr("y1",e?-10:p).attr("y2",e?-10:v);Ub&&d.append("g").attr("class","ygrids");gb&&d.append("g").attr("class","ygrid-lines").selectAll("ygrid-line").data(gb).enter().append("line").attr("class",function(a){return"ygrid-line "+a["class"]});h.append("g").attr("clip-path",Pa).attr("class","regions");h.append("g").attr("clip-path",Pa).attr("class","chart");h.select(".chart").append("g").attr("class",
...
Wb);h.selectAll(".-bar-"+b).classed(Y,!0);h.selectAll("line.xgrid-focus").style("visibility","visible").data([d[0]]).attr(e?"y1":"x1",Oa).attr(e?"y2":"x2",Oa);da.style("top",d3.mouse(this)[1]+30+"px").style("left",(e?d3.mouse(this)[0]:m(d[0].x))+60+"px");da.html(Xb(d));da.style("visibility","visible")}}).on("mouseout",function(a,b){h.select("line.xgrid-focus").style("visibility","hidden");da.style("visibility","hidden");h.selectAll(".-circle-"+b).filter(function(){return d3.select(this).classed(Y)}).classed(Y,
!1).attr("r",hb);h.selectAll(".-bar-"+b).classed(Y,!1)}).on("mousemove",function(a,b){X&&!Qa&&(ca||h.selectAll(".-shape-"+b).filter(function(a){return ea(a)}).each(function(a){a=d3.select(this).classed(Y,!0);"circle"===this.nodeName&&a.attr("r",Wb);d3.select(".event-rect-"+b).style("cursor",null)}).filter(function(a){a=d3.select(this);if("circle"===this.nodeName)return Lb(this,za);if("rect"===this.nodeName)return Mb(this,a.attr("x"),a.attr("y"))}).each(function(a){a=d3.select(this);a.classed(Y)||
(a.classed(Y,!0),"circle"===this.nodeName&&a.attr("r",za));d3.select(".event-rect-"+b).style("cursor","pointer")}))}).on("click",function(a,b){h.selectAll(".-shape-"+b).each(function(a){var d=d3.select(this),c=d.classed(Z),g=!1,f;"circle"===this.nodeName?(g=Lb(this,1.5*za),f=Ob):"rect"===this.nodeName&&(g=Mb(this),f=Qb);if(ca||g)X&&ea(a)&&(d.classed(Z,!c),f(!c,d,a,b)),Cc(a,d)})}).call(d3.behavior.drag().origin(Object).on("drag",function(a){if(X){a=ib[0];var b=ib[1],d=d3.mouse(this),c=d[0],d=d[1],
g=Math.min(a,c),e=Math.max(a,c),k=ca?p:Math.min(b,d),l=ca?v:Math.max(b,d);h.select(".dragarea").attr("x",g).attr("y",k).attr("width",e-g).attr("height",l-k);h.selectAll(".-shapes").selectAll(".-shape").filter(function(a){return ea(a)}).each(function(a,b){var d=d3.select(this),c=d.classed(Z),f=d.classed(jb),h,q,s,m;h=!1;"circle"===this.nodeName?(h=1*d.attr("cx"),q=1*d.attr("cy"),m=Ob,h=g<h&&h<e&&k<q&&q<l):"rect"===this.nodeName&&(h=1*d.attr("x"),q=1*d.attr("y"),s=1*d.attr("width"),m=Qb,h=g<h+s&&h<
e&&q<l);h^f&&(d.classed(jb,!f),d.classed(Z,!c),m(!c,d,a,b))})}}).on("dragstart",function(){X&&(ib=d3.mouse(this),h.select(".chart").append("rect").attr("class","dragarea").style("opacity",0.1),Qa=!0)}).on("dragend",function(){X&&(h.select(".dragarea").transition().duration(100).style("opacity",0).remove(),h.selectAll(".-shape").classed(jb,!1),Qa=!1)})).call(Sb);h.select(".chart").append("g").attr("class","chart-bars");h.select(".chart").append("g").attr("class","chart-lines");la&&(O.append("g").attr("clip-path",
Pa).attr("class","chart"),O.select(".chart").append("g").attr("class","chart-bars"),O.select(".chart").append("g").attr("class","chart-lines"),null!==kb&&ma.extent(H?kb(Na,$a):kb(0,$()-1)),O.append("g").attr("class","x brush").call(ma).selectAll("rect").attr("height",ia),O.append("g").attr("class","x axis").attr("transform","translate(0,"+ia+")").call(ka));na&&Ra(b);Yb(b);I({withTransition:!1});if(Dc){if(H&&"string"==typeof oa){oa=ba(oa);for(a=0;a<b[0].values.length&&0!=b[0].values[a].x-oa;a++);oa=
a}da.html(Xb(b.map(function(a){return Fa(a.values[oa])})));da.style("top",Zb.top).style("left",Zb.left).style("visibility","visible")}}function I(a){var b,d=pc(),c=d.__max__+1,f,s,q,n,u,r;h.select("line.xgrid-focus").style("visibility","hidden");da.style("visibility","hidden");a=k(a)?a:{};b=k(a.withY)?a.withY:!0;u=k(a.withSubchart)?a.withSubchart:!0;r=k(a.withTransition)?a.withTransition:!0;(k(a.withUpdateXDomain)?a.withUpdateXDomain:1)&&m.domain(ma.empty()?y.domain():ma.extent());x.domain(E(l.data.targets,
"y"));Q.domain(E(l.data.targets,"y2"));h.selectAll(".x.axis").transition().duration(e?250:0).call(e?ja:D);h.selectAll(".y.axis").transition().duration(e?0:250).call(e?D:ja);h.selectAll(".y2.axis").transition().call(Ja);Ha.domain(x.domain());Ia.domain(Q.domain());if(Tb){if("year"===Ec)for(a=[],firstYear=Na.getFullYear(),lastYear=$a.getFullYear(),f=firstYear;f<=lastYear;f++)a.push(new Date(f+"-01-01 00:00:00"));else a=m.ticks(10);a=h.select(".xgrids").selectAll(".xgrid").data(a);a.enter().append("line").attr("class",
...
if(!("data"in z))throw Error("data is required in config");var Ma=c(["data","x"],"x"),Ic=c(["data","x_format"],"%Y-%m-%d"),lc=c(["data","id_converter"],function(a){return a}),xa=c(["data","names"],{}),r=c(["data","groups"],[]),Cb=c(["data","axes"],{}),W=c(["data","types"],{}),ac=c(["data","regions"],{}),Jc=c(["data","colors"],{}),X=c(["data","selection","enabled"],!1),ca=c(["data","selection","grouped"],!1),ea=c(["data","selection","isselectable"],function(a){return!0}),la=c(["subchart","show"],!1),
sb=la?c(["subchart","size","height"],60):0,kb=c(["subchart","default"],null),Kc=c(["color","pattern"],null),na=c(["legend","show"],!0),Ba=c(["legend","item","width"],80),Hc=c(["legend","item","onclick"],function(){}),bc=c(["axis","x","type"],"indexed"),Sa=c(["axis","x","categories"],[]),cc=c(["axis","x","tick","centered"],!1),hc=c(["axis","y","max"],null),fc=c(["axis","y","min"],null),jc=c(["axis","y","center"],null),Ac=c(["axis","y","text"],null);c(["axis","y","rescale"],!0);var Xa=c(["axis","y",
"inner"],!1),xc=c(["axis","y","format"],function(a){return a}),va=c(["axis","y","padding"],null),wc=c(["axis","y","ticks"],10),ub=c(["axis","y2","show"],!1),gc=c(["axis","y2","max"],null),ec=c(["axis","y2","min"],null),ic=c(["axis","y2","center"],null);c(["axis","y2","text"],null);c(["axis","y2","rescale"],!0);var Wa=c(["axis","y2","inner"],!1),zc=c(["axis","y2","format"],function(a){return a}),wa=c(["axis","y2","padding"],null),yc=c(["axis","y2","ticks"],10),e=c(["axis","rotated"],!1),Tb=c(["grid",
"x","show"],!1),Ec=c(["grid","x","type"],"tick"),fb=c(["grid","x","lines"],null),Ub=c(["grid","y","show"],!1);c(["grid","y","type"],"tick");var gb=c(["grid","y","lines"],null),hb=c(["point","show"],!0)?c(["point","r"],2.5):0,Bc=c(["point","focus","line","enabled"],!0),Vb=c(["point","focus","expand","enabled"],!0),Wb=c(["point","focus","expand","r"],Vb?4:hb),za=c(["point","focus","select","r"],8),Cc=c(["point","onclick"],function(){}),sc=c(["point","onselected"],function(){}),tc=c(["point","onunselected"],
...
Dc=c(["tooltip","init","show"],!1),oa=c(["tooltip","init","x"],0),Zb=c(["tooltip","init","position"],{top:"0px",left:"50px"}),mb=z.bindto.replace("#","")+"-clip",Pa="url(#"+mb+")",H="timeseries"===bc,fa="categorized"===bc,ib=null,Qa=!1,aa=na?40:0,Lc=function(a){return function(b){for(var d=a.length-1,c=a[d];!c[1](b);)c=a[--d];return c[0](b)}}([[d3.time.format("%Y/%-m/%-d"),function(){return!0}],[d3.time.format("%-m/%-d"),function(a){return a.getMonth()}],[d3.time.format("%-m/%-d"),function(a){return 1!=
a.getDate()}],[d3.time.format("%-m/%-d"),function(a){return a.getDay()&&1!=a.getDate()}],[d3.time.format("%I %p"),function(a){return a.getHours()}],[d3.time.format("%I:%M"),function(a){return a.getMinutes()}],[d3.time.format(":%S"),function(a){return a.getSeconds()}],[d3.time.format(".%L"),function(a){return a.getMilliseconds()}]]),ba=d3.time.format(Ic).parse,rb,wb,tb,vb,xb,t,v,ia,zb,Ab,Ya,Za,m,x,Q,y,Ha,Ia,D=fa?pb():d3.svg.axis(),ja=d3.svg.axis(),Ja=d3.svg.axis(),ka=fa?pb():d3.svg.axis();P();S();
H&&D.tickFormat(Lc);fa?(D.categories(Sa).tickCentered(cc),ka.categories(Sa).tickCentered(cc)):(D.tickOffset=function(){return 0},ka.tickOffset=function(){return 0});fa&&function(){var a=m,b=y,c=Object.keys(m),g,f;m=function(b){return a(b)+D.tickOffset()};y=function(a){return b(a)+ka.tickOffset()};for(f=0;f<c.length;f++)g=c[f],m[g]=a[g],y[g]=b[g];m.domain=function(b){if(!arguments.length)return b=a.domain(),b[1]++,b;a.domain(b);return m}}();var Fc=function(){var a=d3.svg.line().x(e?function(a){return F(a.id)(a.value)}:
Oa).y(e?Oa:function(a){return F(a.id)(a.value)});return function(b){var c;if(cb(b))return"spline"===W["string"===typeof b?b:b.id]?a.interpolate("cardinal"):a.interpolate("linear"),0<Object.keys(ac).length?vc(b.values,m,F(b.id),ac[b.id]):a(b.values);c=m(b.values[0].x);b=F(b.id)(b.values[0].value);return e?"M "+b+" "+c:"M "+c+" "+b}}(),Gc=function(){var a=d3.svg.line().x(function(a){return y(a.x)}).y(function(a){return B(a.id)(a.value)});return function(b){return cb(b)?a(b.values):"M "+y(b.values[0].x)+
" "+B(b.id)(b.values[0].value)}}(),lb=function(a){return"start"in a?m(H?ba(a.start):a.start):0},$b=function(a){var b=lb(a);a=("end"in a?m(H?ba(a.end):a.end):t)-b;return 0>a?0:a},R=function(a,b){var c=[],g=null!==b?b:"#1f77b4 #ff7f0e #2ca02c #d62728 #9467bd #8c564b #e377c2 #7f7f7f #bcbd22 #17becf".split(" ");return function(b){if(b in a)return a[b];0<=c.indexOf(b)||c.push(b);return g[c.indexOf(b)%g.length]}}(Jc,Kc),Ta=d3.select(z.bindto).append("svg").attr("width",t+G+C).attr("height",v+p+T),nb=Ta.append("defs");
...
Ka(function(b){return b.id==a});return 0<b.length?b[0]:void 0};if("url"in z.data)d3.csv(z.data.url,function(a,b){eb(b)});else if("rows"in z.data)eb(qa(z.data.rows));else if("columns"in z.data)eb(ra(z.data.columns));else throw Error("url or rows or columns is required.");ob.onresize=function(){P();S();d3.select("svg").attr("width",t+G+C);d3.select("#"+mb).select("rect").attr("width",t);d3.select("#xaxis-clip").select("rect").attr("width",t+2);na&&Ra(l.data.targets,{withTransition:!1});I({withTransition:!1})};
return l}})(window);
