...
P.c3={},d=P.d3;yb.generate=function(ba){var gc,hc,Ea,Fa,n,r,A,O,Y;function f(a,b){for(var c=ba,e=0;e<a.length;e++){if(!(a[e]in c))return b;c=c[a[e]]}return c}function ra(){zb=null===$a?ca():$a;sa=X();r=0;A=(g?Ab+kc:0)+(ab?ab:bb?1:40);O=20+(g?0:Ab)+la;Y=cb?cb:Bb?db||g?1:40:20;p=zb-A-Y;s=sa-r-O;Ea=g?r:sa-Ab-la;Fa=g?lc:A;n=20+la;Cb=g?A-lc-kc:p;eb=g?s:sa-Ea-n;gc=sa-la;hc=A;Db=s/2;Ga=0.95*Db;Eb=ma(h.data.targets,"dount")?0.6*Ga:0}function X(){var a=null===mc?+d.select(ta).style("height").replace("px",
...
function(a){return 0===a%1?gb.tickOffset():0});hb=T(Jb,Kb);ib=T(Jb,Kb);J=ic(m,nd);va=d.svg.axis().scale(z).orient(od);jb=d.svg.axis().scale(Z).orient(pd);gb=ic(V,qd);kb=Wa();nc=ka();oc=ka(0.98)}function S(a,b,c,e){var k=(B?d.time.scale():d.scale.linear()).range([a,b]);k.orgDomain=function(){return k.domain()};u(c)&&k.domain(c);x(e)&&(e=function(){return 0});if(ea){var H=k,f,k=function(a){return H(a)+e(a)};for(f in H)k[f]=H[f];k.orgDomain=function(){return H.domain()};k.domain=function(a){if(!arguments.length)return a=
H.domain(),[a[0],a[1]+1];H.domain(a);return k}}return k}function T(a,b){return d.scale.linear().range([a,b])}function w(a){return"y2"===y(a)?Z:z}function G(a){return"y2"===y(a)?ib:hb}function ic(a,b){var c=(ea?ld():d.svg.axis()).scale(a).orient(b);c.tickFormat(jc());ea?c.categories(Ha).tickCentered(rd):c.tickOffset=function(){return 0};return c}function y(a){return a in pc?pc[a]:"y"}function jc(){var a=B?sd:ea?td:function(a){return a};lb&&(a="function"===typeof lb?lb:B?function(a){return d.time.format(lb)(a)}:
...
kb);q.selectAll(".-arc").style("opacity",1)}function ud(a){var b=qc(a),c,e,k,H;if(0<t.length)for(H=rc(a),a=0;a<t.length;a++)for(e=t[a][0],H&&b[e]&&b[e].forEach(function(a,c){b[e][c]=0>a?a:0}),c=1;c<t[a].length;c++)k=t[a][c],b[k]&&b[k].forEach(function(a,c){y(k)!==y(e)||!b[e]||H&&0<+a||(b[e][c]+=+a)});return d.min(Object.keys(b).map(function(a){return d.min(b[a])}))}function vd(a){var b=qc(a),c,e,k,H;if(0<t.length)for(H=wd(a),a=0;a<t.length;a++)for(e=t[a][0],H&&b[e]&&b[e].forEach(function(a,c){b[e][c]=
...
function Gd(a){for(var b=[],c=0;c<a.length;c++)a[c]in pb&&b.push(sc(pb[a[c]]));return b}function Mb(a){return"start"in a?m(B?na(a.start):a.start):0}function tc(a){var b=Mb(a);a=("end"in a?m(B?na(a.end):a.end):p)-b;return 0>a?0:a}function uc(a){return oa&&a===oa||$&&Hd($,a)}function Id(a){return!uc(a)}function Jd(a){Object.keys(a).forEach(function(b){$[b]=a[b]})}function qb(a){var b;a&&(b=Ka[a.id],a.name=b?b:a.id);return a}function vc(a){var b=a[0],c={},e=[],k,d;for(k=1;k<a.length;k++){c={};for(d=
0;d<a[k].length;d++)c[b[d]]=a[k][d];e.push(c)}return e}function wc(a){var b=[],c,e,k;for(c=0;c<a.length;c++)for(k=a[c][0],e=1;e<a[c].length;e++)x(b[e-1])&&(b[e-1]={}),b[e-1][k]=a[c][e];return b}function La(a){var b=d.keys(a[0]).filter(Id),c=d.keys(a[0]).filter(uc);if(B&&0===c.length)return P.alert('data.x or data.xs must be specified when axis.x.type == "timeseries"'),[];Nb&&b.forEach(function(b){var k=oa?oa:$?$[b]:null;0<=c.indexOf(k)?h.data.x[b]=a.map(function(a){return a[k]}):h.data.x[b]=h.data.x[Object.keys(h.data.x)[0]]});
b=b.map(function(b){var c=Kd(b);return{id:c,id_org:b,values:a.map(function(a,d){var f;f=oa?oa:$?$[b]:null;f=B?na(a[f]):Nb?a[f]?a[f]:b in h.data.x&&h.data.x[b]&&h.data.x[b][d]?h.data.x[b][d]:d:d;a.x=f;return{x:f,value:null===a[b]||isNaN(a[b])?null:+a[b],id:c}})}});b.forEach(function(a){var b;a.values=a.values.sort(function(a,b){return(a.x||0===a.x?a.x:Infinity)-(b.x||0===b.x?b.x:Infinity)});b=0;a.values.forEach(function(a){a.index=b++})});xc&&Ma(rb(b).filter(function(a){return!(a in C)}),xc);b.forEach(function(a){pb[a.id_org]=
sc(a)});return b}function sc(a){return{id:a.id,id_org:a.id_org,values:a.values.map(function(a){return{x:a.x,value:a.value,id:a.id}})}}function yc(a){return 0<a&&h.data.targets[0].values[a-1]?h.data.targets[0].values[a-1].x:void 0}function fb(){return d.max(h.data.targets,function(a){return a.values.length})}function Ld(){var a=h.data.targets.length,b=0,c;1<a?h.data.targets.forEach(function(a){a.values.length>b&&(c=a,b=a.values.length)}):c=a?h.data.targets[0]:null;return c}function rb(a){a=x(a)?h.data.targets:
a;return a.map(function(a){return a.id})}function zc(a){var b=rb(),c;for(c=0;c<b.length;c++)if(b[c]===a)return!0;return!1}function nb(a){return u(a)?h.data.targets.filter(a):h.data.targets}function qc(a){var b={};a.forEach(function(a){b[a.id]=[];a.values.forEach(function(e){b[a.id].push(e.value)})});return b}function Ac(a,b){var c=Object.keys(a),e,k,d;for(e=0;e<c.length;e++)for(d=a[c[e]].values,k=0;k<d.length;k++)if(b(d[k].value))return!0;return!1}function rc(a){return Ac(a,function(a){return 0>a})}
function wd(a){return Ac(a,function(a){return 0<a})}function td(a){return a<Ha.length?Ha[a]:a}function Na(a){return"-shapes -shapes-"+a.id}function Bc(a){return Na(a)+" -line -line-"+a.id}function Md(a){return Na(a)+" -circles -circles-"+a.id}function Cc(a){return Na(a)+" -bars -bars-"+a.id}function Nd(a){return Na(a.data)+" -arc -arc-"+a.data.id}function Od(a){return Na(a)+" -area -area-"+a.id}function Pd(a,b){return"-shape -shape-"+b+" -circle -circle-"+b}function Dc(a,b){return"-shape -shape-"+
b+" -bar -bar-"+b}function Qd(a,b){return"region region-"+b+" "+("classes"in a?[].concat(a.classes).join(" "):"")}function Ec(a,b){return"event-rect event-rect-"+b}function Rd(a){return a.value?Fc(a)?0.5:1:0}function wa(a){return m(a.x)}function Oa(a){return m(B?na(a.value):a.value)}function Pa(a){return z(a.value)}function Gc(a){return V(a.x)}function Hc(a,b){var c,e=a[b].x,k=[];for(c=b-1;0<=c&&e===a[c].x;c--)k.push(a[c]);for(c=b;c<a.length&&e===a[c].x;c++)k.push(a[c]);return k}function Ic(a,b,c,
e){c=c?c:0;e=e?e:a.length-1;var k=Math.floor((e-c)/2)+c;0<m(a[k].x)-b[0]?e=k:c=k;return 1===e-c?(k=[],a[c].x&&(k=k.concat(Hc(a,c))),a[e].x&&(k=k.concat(Hc(a,e))),Jc(k,b)):Ic(a,b,c,e)}function Kc(a,b){var c;c=a.map(function(a){return Ic(a.values,b)});return Jc(c,b)}function Jc(a,b){var c,e;a.forEach(function(a){var d=Ob(a,b);if(d<c||!c)c=d,e=a});return e}function Lc(a,b){var c,e,k,d,f;0!==a.filter(function(a){return a&&a.value}).length&&(W.html(Mc(a)).style("visibility","hidden").style("display","block"),
c=W.property("offsetWidth"),e=W.property("offsetHeight"),g?d=b[0]:(k=q.property("offsetLeft"),d=k+(ab?ab:bb?1:40)+m(a[0].x)+20,f=d+c,k=k+(null===$a?ca():$a)-(cb?cb:Bb?db||g?1:40:20),f>k&&(d-=c+30)),c=b[1]+15+e<X()?b[1]+15:b[1]-e,W.style("top",c+"px").style("left",d+"px").style("visibility","visible"))}function Nc(a){ma(h.data.targets,"scatter")||D(h.data.targets)||l.selectAll("line.xgrid-focus").style("visibility","visible").data([a]).attr(g?"y1":"x1",wa).attr(g?"y2":"x2",wa)}function Oc(){l.select("line.xgrid-focus").style("visibility",
...
p).attr("dy","-.5em").style("text-anchor","end").text(he);l.append("g").attr("class","y axis").attr("clip-path",g?"url(#yaxis-clip)":"").call(g?J:va).append("text").attr("transform","rotate(-90)").attr("dy","1.2em").attr("dx","-.5em").style("text-anchor","end").text(ie);Bb&&l.append("g").attr("class","y2 axis").attr("transform",M.y2).call(jb);a=l.append("g").attr("clip-path",Ra).attr("class","grid");Zc&&a.append("g").attr("class","xgrids");Yb&&(b=a.append("g").attr("class","xgrid-lines").selectAll(".xgrid-line").data(Yb).enter().append("g").attr("class",
"xgrid-line"),b.append("line").attr("class",function(a){return""+a["class"]}),b.append("text").attr("class",function(a){return""+a["class"]}).attr("text-anchor","end").attr("transform",g?"":"rotate(-90)").attr("dx",g?0:-r).attr("dy",-5).text(function(a){return a.text}));je&&a.append("g").attr("class","xgrid-focus").append("line").attr("class","xgrid-focus").attr("x1",g?0:-10).attr("x2",g?p:-10).attr("y1",g?-10:r).attr("y2",g?-10:s);$c&&a.append("g").attr("class","ygrids");Zb&&(a=a.append("g").attr("class",
...
Aa&&(F.append("g").attr("clip-path",Ra).attr("class","chart"),F.select(".chart").append("g").attr("class","chart-bars"),F.select(".chart").append("g").attr("class","chart-lines"),F.append("g").attr("clip-path",Ra).attr("class","x brush").call(L).selectAll("rect").attr(g?"width":"height",g?Cb:eb),F.append("g").attr("class","x axis").attr("transform",M.subx).attr("clip-path",g?"url(#yaxis-clip)":"").call(gb));Ca&&wb(h.data.targets);ad(h.data.targets);I({withTransition:!1,withUpdateXDomain:!0});if(le){if(B&&
"string"===typeof Da){Da=na(Da);for(a=0;a<h.data.targets[0].values.length&&0!==h.data.targets[0].values[a].x-Da;a++);Da=a}W.html(Mc(h.data.targets.map(function(a){return qb(a.values[Da])})));W.style("top",bd.top).style("left",bd.left).style("display","block")}null==P.onresize&&(P.onresize=me());P.onresize.add&&P.onresize.add(ne)}}function oe(a){a.append("rect").attr("class",Ec).style("cursor",fa&&qa?"pointer":null).on("mouseover",function(a,c){if(!Sa&&!D(h.data.targets)){var e=h.data.targets.map(function(a){return qb(a.values[c])}),
d,f;if(0<Object.keys(Ka).length){f=[];for(var g in Ka)for(d=0;d<e.length;d++)if(e[d].id===g){f.push(e[d]);e.shift(d);break}e=f.concat(e)}$b&&Tb(c,void 0).classed(aa,!0).attr("r",ac);Yc(c).classed(aa,!1);Nc(e[0])}}).on("mouseout",function(a,c){D(h.data.targets)||(Oc(),W.style("display","none"),Ub(c),Yc(void 0).classed(aa,!1))}).on("mousemove",function(a,c){var e;Sa||D(h.data.targets)||(e=h.data.targets.map(function(a){return qb(a.values[c])}),Lc(e,d.mouse(this)),fa&&(qa||l.selectAll(".-shape-"+c).filter(function(a){return ga(a)}).each(function(){var a=
d.select(this).classed(aa,!0);"circle"===this.nodeName&&a.attr("r",ac);q.select(".event-rect-"+c).style("cursor",null)}).filter(function(){var a=d.select(this);if("circle"===this.nodeName)return Sc(this,Qa);if("rect"===this.nodeName)return Tc(this,a.attr("x"),a.attr("y"))}).each(function(){var a=d.select(this);a.classed(aa)||(a.classed(aa,!0),"circle"===this.nodeName&&a.attr("r",Qa));q.select(".event-rect-"+c).style("cursor","pointer")})))}).on("click",function(a,c){D(h.data.targets)||(bc?bc=!1:l.selectAll(".-shape-"+
c).each(function(a){cd(this,a,c)}))}).call(d.behavior.drag().origin(Object).on("drag",function(){dd(d.mouse(this))}).on("dragstart",function(){ed(d.mouse(this))}).on("dragend",function(){fd()})).call(E).on("dblclick.zoom",null)}function pe(a){a.append("rect").attr("x",0).attr("y",0).attr("width",p).attr("height",s).attr("class","event-rect").on("mouseout",function(){D(h.data.targets)||(Oc(),W.style("display","none"),Ub())}).on("mousemove",function(){var a,c,e;Sa||D(h.data.targets)||(a=d.mouse(this),
c=Kc(h.data.targets,a),e=[qb(c)],Lc(e,a),$b&&(Ub(),Tb(c.index,c.id).classed(aa,!0).attr("r",ac)),Nc(e[0]),100>Ob(c,a)?q.select(".event-rect").style("cursor","pointer"):q.select(".event-rect").style("cursor",null))}).on("click",function(){var a,c;D(h.data.targets)||(a=d.mouse(this),c=Kc(h.data.targets,a),100>Ob(c,a)&&l.select(".-circles-"+c.id).select(".-circle-"+c.index).each(function(){cd(this,c,c.index)}))}).call(d.behavior.drag().origin(Object).on("drag",function(){dd(d.mouse(this))}).on("dragstart",
function(){ed(d.mouse(this))}).on("dragend",function(){fd()})).call(E).on("dblclick.zoom",null)}function cd(a,b,c){var e=d.select(a),f=e.classed(ha),g=!1,h;"circle"===a.nodeName?(g=Sc(a,1.5*Qa),h=Vc):"rect"===a.nodeName&&(g=Tc(a),h=Xc);if(qa||g)fa&&ga(b)&&(e.classed(ha,!f),h(!f,e,b,c)),qe(b,e)}function dd(a){var b,c,e,f,g,m,p;D(h.data.targets)||!fa||pa&&!E.altDomain||(b=cc[0],c=cc[1],e=a[0],a=a[1],f=Math.min(b,e),g=Math.max(b,e),m=qa?r:Math.min(c,a),p=qa?s:Math.max(c,a),l.select(".dragarea").attr("x",
f).attr("y",m).attr("width",g-f).attr("height",p-m),l.selectAll(".-shapes").selectAll(".-shape").filter(function(a){return ga(a)}).each(function(a,b){var c=d.select(this),e=c.classed(ha),h=c.classed(dc),l,n,r,q;l=!1;"circle"===this.nodeName?(l=1*c.attr("cx"),n=1*c.attr("cy"),q=Vc,l=f<l&&l<g&&m<n&&n<p):"rect"===this.nodeName&&(l=1*c.attr("x"),n=1*c.attr("y"),r=1*c.attr("width"),q=Xc,l=f<l+r&&l<g&&n<p);l^h&&(c.classed(dc,!h),c.classed(ha,!e),q(!e,c,a,b))}))}function ed(a){!D(h.data.targets)&&fa&&(cc=
a,l.select(".chart").append("rect").attr("class","dragarea").style("opacity",0.1),Sa=!0)}function fd(){!D(h.data.targets)&&fa&&(l.select(".dragarea").transition().duration(100).style("opacity",0).remove(),l.selectAll(".-shape").classed(dc,!1),Sa=!1)}function I(a){var b,c,e,f=Sd(),n=f.__max__+1,q,v,t=D(h.data.targets);a=u(a)?a:{};c=u(a.withY)?a.withY:!0;e=u(a.withSubchart)?a.withSubchart:!0;v=u(a.withTransition)?a.withTransition:!0;b=u(a.withUpdateXDomain)?a.withUpdateXDomain:!1;a=u(a.withUpdateOrgXDomain)?
...
h(a.id)(0),l=d(a,f)||k,k=[[c(a),l],[c(a),e(a)-(k-l)],[c(a)+b,e(a)-(k-l)],[c(a)+b,l]],l=g?1:0,m=g?0:1;return"M "+k[0][l]+","+k[0][m]+" L"+k[1][l]+","+k[1][m]+" L"+k[2][l]+","+k[2][m]+" L"+k[3][l]+","+k[3][m]+" z"}};b=l.selectAll(".-bars").selectAll(".-bar").data(Rc);b.enter().append("path").attr("d",c(!1)).style("stroke","none").style("opacity",0).style("fill",function(a){return K(a.id)}).attr("class",Dc);b.transition().duration(v).attr("d",c(!1)).style("opacity",1);b.exit().transition().duration(v).style("opacity",
...
function(a){a=ja(a);if(!a)return function(){return"M 0 0"};var b=d.interpolate(this._current,a);this._current=b(0);return function(a){a=b(a);return Qc(a.data)?kb(a,!0):"M 0 0"}}).style("opacity",1);l.selectAll(".chart-arc").select("text").attr("transform",Xa).attr("opacity",0).transition().duration(v).text(Ya).attr("opacity",function(a){return Qc(a.data)?1:0});Aa&&(null!==d.event&&"zoom"===d.event.type&&L.extent(m.orgDomain()).update(),e&&(F.select(".x.axis").transition().duration(g?v:0).call(gb),
L.empty()||L.extent(m.orgDomain()).update(),e=F.selectAll(".-bars").selectAll(".-bar").data(Rc),e.enter().append("path").attr("d",c(!0)).style("stroke","none").style("fill",function(a){return K(a.id)}).attr("class",Dc),e.style("opacity",0).transition().duration(v).attr("d",c(!0)).style("opacity",1),e.exit().transition().duration(v).style("opacity",0).remove(),F.selectAll(".-line").transition().duration(v).attr("d",ue)));l.selectAll(".selected-circles").filter(function(a){return sb(a)}).selectAll("circle").remove();
l.selectAll(".selected-circle").transition().duration(v).attr("cx",g?ya:xa).attr("cy",g?xa:ya);$?(c=l.select(".event-rects").selectAll(".event-rect").data([0]),pe(c.enter()),c.attr("x",0).attr("y",0).attr("width",p).attr("height",s)):(Nb?(q=function(a,b){var c=yc(b),e=b<fb()-1?h.data.targets[0].values[b+1].x:void 0;return(m(e?e:a.x+50)-m(c?c:a.x-50))/2},e=function(a,b){var c=yc(b);return(m(a.x)+m(c?c:a.x-50))/2}):(q=md(),e=function(a){return m(a.x)-q/2}),c=Ld(),l.select(".event-rects").datum(c?c.values:
[]),c=l.select(".event-rects").selectAll(".event-rect").data(function(a){return a}),oe(c.enter()),c.attr("class",Ec).attr("x",g?0:e).attr("y",g?e:0).attr("width",g?p:q).attr("height",g?q:s),c.exit().remove());e=l.select(".regions").selectAll("rect.region").data(Q);e.enter().append("rect");e.attr("class",Qd).attr("x",g?0:Mb).attr("y",g?Mb:r).attr("width",g?p:tc).attr("height",g?tc:s).style("fill-opacity",function(a){return u(a.opacity)?a.opacity:0.1});e.exit().transition().duration(v).style("fill-opacity",
...
xd=f(["axis","y2","min"],null),Bd=f(["axis","y2","center"],null),db=f(["axis","y2","inner"],!1),ee=f(["axis","y2","tick","format"],function(a){return a}),Ja=f(["axis","y2","padding"],null),de=f(["axis","y2","ticks"],10),g=f(["axis","rotated"],!1),Zc=f(["grid","x","show"],!1),re=f(["grid","x","type"],"tick"),Yb=f(["grid","x","lines"],null),$c=f(["grid","y","show"],!1),Zb=f(["grid","y","lines"],null),Vb=f(["point","show"],!0)?f(["point","r"],2.5):0,je=f(["point","focus","line","enabled"],!0),$b=f(["point",
"focus","expand","enabled"],!0),ac=f(["point","focus","expand","r"],$b?4:Vb),Qa=f(["point","focus","select","r"],8),qe=f(["point","onclick"],function(){}),Yd=f(["point","onselected"],function(){}),Zd=f(["point","onunselected"],function(){}),Q=f(["regions"],[]),Mc=f(["tooltip","contents"],function(a){var b="<table class='-tooltip'><tr><th colspan='2'>"+jc()(a[0].x)+"</th></tr>",c,d,f;for(c=0;c<a.length;c++)a[c]&&(a[c].value||0===a[c].value)&&(d=u(a[c].value)?(Math.round(100*a[c].value)/100).toFixed(2):
"-",f=a[c].name,b+="<tr class='-tooltip-name-"+a[c].id+"'><td class='name'><span style='background-color:"+K(a[c].id)+"'></span>"+f+"</td><td class='value'>"+d+"</td></tr>");return b+"</table>"}),le=f(["tooltip","init","show"],!1),Da=f(["tooltip","init","x"],0),bd=f(["tooltip","init","position"],{top:"0px",left:"50px"}),Xb=ta.replace("#","")+"-clip",Ra="url(#"+Xb+")",B="timeseries"===kd,ea="categorized"===kd,Nb=!B&&(oa||$),cc=null,Sa=!1,bc=!1,la=Ca?40:0,K=function(a,b){var c=[],d=null!==b?b:"#1f77b4 #ff7f0e #2ca02c #d62728 #9467bd #8c564b #e377c2 #7f7f7f #bcbd22 #17becf".split(" ");
...
null}).on("zoom",pa?ve:null);L.update=function(){F&&F.select(".x.brush").call(this);return this};L.scale=function(a){return g?this.y(a):this.x(a)};E.scale=function(a){return g?this.y(a):this.x(a)};E.orgScaleExtent=function(){var a=id?id:[1,10];return[a[0],Math.max(fb()/a[1],a[1])]};E.updateScaleExtent=function(){var a=ua(m.orgDomain())/ua(U),b=this.orgScaleExtent();this.scaleExtent([b[0]*a,b[1]*a]);return this};var q,ub,l,F,Ba,W,tb,U;h.focus=function(a){var b=q.selectAll(Va(a)),c=b.filter(ec),b=b.filter(fc);
h.defocus();c.classed("focused",!0).transition().duration(100).style("opacity",1);b.transition().duration(100).style("opacity",1);D(h.data.targets)&&Za(a,!0)};h.defocus=function(a){var b=q.selectAll(Va(a)),c=b.filter(ec),b=b.filter(fc);c.classed("focused",!1).transition().duration(100).style("opacity",0.3);b.transition().duration(100).style("opacity",0.3);D(h.data.targets)&&xb(a)};h.revert=function(a){var b=q.selectAll(Va(a)),c=b.filter(ec),b=b.filter(fc);c.classed("focused",!1).transition().duration(100).style("opacity",
1);b.transition().duration(100).style("opacity",1);D(h.data.targets)&&xb(a)};h.show=function(a){q.selectAll(Va(a)).transition().style("opacity",1)};h.hide=function(a){q.selectAll(Va(a)).transition().style("opacity",0)};h.unzoom=function(){L.clear().update();I({withUpdateXDomain:!0})};h.load=function(a){"function"!==typeof a.done&&(a.done=function(){});a.xs&&Jd(a.xs);"categories"in a&&ea&&(Ha=a.categories,J.categories(Ha));if("cacheIds"in a&&Fd(a.cacheIds))Ta(Gd(a.cacheIds),a.done);else if("data"in
a)Ta(La(a.data),a.done);else if("url"in a)d.csv(a.url,function(b,c){Ta(La(c),a.done)});else if("rows"in a)Ta(La(vc(a.rows)),a.done);else if("columns"in a)Ta(La(wc(a.columns)),a.done);else throw Error("url or rows or columns is required.");};h.unload=function(a){h.data.targets=h.data.targets.filter(function(b){return b.id!==a});q.selectAll(".target-"+a).transition().style("opacity",0).remove();Ca&&(q.selectAll(".legend-item-"+a).remove(),wb(h.data.targets));0<h.data.targets.length&&I({withUpdateOrgXDomain:!0,
withUpdateXDomain:!0})};h.selected=function(a){a=u(a)?"-"+a:"";return d.merge(l.selectAll(".-shapes"+a).selectAll(".-shape").filter(function(){return d.select(this).classed(ha)}).map(function(a){return a.map(function(a){return a.__data__})}))};h.select=function(a,b,c){fa&&l.selectAll(".-shapes").selectAll(".-shape").each(function(e,f){var g="circle"===this.nodeName?Uc:$d,h="circle"===this.nodeName?Rb:Wc;0<=b.indexOf(f)?ga(e)&&(qa||x(a)||0<=a.indexOf(e.id))&&g(d.select(this).classed(ha,!0),e,f):u(c)&&
c&&h(d.select(this).classed(ha,!1),e,f)})};h.unselect=function(a,b){fa&&l.selectAll(".-shapes").selectAll(".-shape").each(function(c,e){var f="circle"===this.nodeName?Rb:Wc;(x(b)||0<=b.indexOf(e))&&ga(c)&&(qa||x(a)||0<=a.indexOf(c.id))&&f(d.select(this).classed(ha,!1),c,e)})};h.toLine=function(a){Ma(a,"line");I()};h.toSpline=function(a){Ma(a,"spline");I()};h.toBar=function(a){Ma(a,"bar");I()};h.toScatter=function(a){Ma(a,"scatter");I()};h.groups=function(a){if(x(a))return t;t=a;I();return t};h.regions=
...
function(a){var b=nb(function(b){return b.id===a});return 0<b.length?b[0]:void 0};h.destroy=function(){h.data.targets=void 0;h.data.x={};tb.html("");P.onresize=null};if("url"in ba.data)d.csv(ba.data.url,function(a,b){Wb(b)});else if("rows"in ba.data)Wb(vc(ba.data.rows));else if("columns"in ba.data)Wb(wc(ba.data.columns));else throw Error("url or rows or columns is required.");return h}})(window);
