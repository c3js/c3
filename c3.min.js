(function(O){function wd(){function v(e,g){e.attr("transform",function(e){return"translate("+(g(e)+fa)+", 0)"})}function y(e,g){e.attr("transform",function(e){return"translate(0,"+g(e)+")"})}function O(e){var g=e[0];e=e[e.length-1];return g<e?[g,e]:[e,g]}function Ha(e){for(var g=[],q=Math.ceil(e[0]);q<e[1];q++)g.push(q);0<g.length&&0<g[0]&&g.unshift(g[0]-(g[1]-g[0]));return g}function Ia(e){e=e<W.length?W[e]:e;return Q?Q(e):e}function p(p){p.each(function(){var p=e.select(this),oa=Ha(q.domain()),
X=p.selectAll(".tick.major").data(oa,String),Y=X.enter().insert("g","path").attr("class","tick major").style("opacity",1E-6),ga=e.transition(X.exit()).style("opacity",1E-6).remove(),ha=e.transition(X).style("opacity",1),I,u=q.rangeExtent?q.rangeExtent():O(q.range()),p=p.selectAll(".domain").data([0]);p.enter().append("path").attr("class","domain");var p=e.transition(p),B=q.copy(),W=this.__chart__||B;this.__chart__=B;Y.append("line");Y.append("text");var R=Y.select("line"),Q=ha.select("line"),Z=X.select("text"),
ab=Y.select("text"),Ja=ha.select("text");fa=(B(1)-B(0))/2;X=va?0:fa;switch(C){case "bottom":I=v;R.attr("y2",M);ab.attr("y",Math.max(M,0)+g);Q.attr("x1",X).attr("x2",X).attr("y2",M);Ja.attr("x",0).attr("y",Math.max(M,0)+g);Z.attr("dy",".71em").style("text-anchor","middle");Z.text(function(e){return oa.length<S||0===e%Math.ceil(oa.length/S)?Ia(e):""});p.attr("d","M"+u[0]+","+$+"V0H"+u[1]+"V"+$);break;case "left":I=y,R.attr("x2",-M),ab.attr("x",-(Math.max(M,0)+g)),Q.attr("x2",-M).attr("y2",0),Ja.attr("x",
-(Math.max(M,0)+g)).attr("y",fa),Z.attr("dy",".32em").style("text-anchor","end"),Z.text(function(e){return oa.length<S||0===e%Math.ceil(oa.length/S)?Ia(e):""}),p.attr("d","M"+-$+","+u[0]+"H0V"+u[1]+"H"+-$)}if(q.ticks)Y.call(I,W),ha.call(I,B),ga.call(I,B);else{var zb=B.rangeBand()/2,ga=function(e){return B(e)+zb};Y.call(I,ga);ha.call(I,ga)}})}var q=e.scale.linear(),C="bottom",M=6,$=6,g=3,va=!1,S=10,fa=0,Q=null,W=[];p.scale=function(e){if(!arguments.length)return q;q=e;return p};p.orient=function(e){if(!arguments.length)return C;
C=e in{top:1,right:1,bottom:1,left:1}?e+"":"bottom";return p};p.categories=function(e){if(!arguments.length)return W;W=e;return p};p.tickCentered=function(e){if(!arguments.length)return va;va=e;return p};p.tickTextNum=function(e){if(!arguments.length)return S;S=e;return p};p.tickFormat=function(e){if(!arguments.length)return Q;Q=e;return p};p.tickOffset=function(){return fa};p.ticks=function(){};return p}function y(e){return"undefined"===typeof e}function v(e){return"undefined"!==typeof e}var Ab=
O.c3={},e=O.d3;Ab.generate=function(ea){var pc,qc,Ha,Ia,p,q,C,M,$;function g(a,b){for(var c=ea,d=0;d<a.length;d++){if(!(a[d]in c))return b;c=c[a[d]]}return c}function va(){Bb=Ka?Ka:Q();wa=fa();q=0;C=(h?Cb+tc:0)+(bb?bb:cb?1:40);M=20+(h?0:Cb)+pa;$=db?db:Db?eb||h?1:40:1;r=Bb-C-$;s=wa-q-M;Ha=h?q:wa-Cb-pa;Ia=h?uc:C;p=20+pa;Eb=h?C-uc-tc:r;fb=h?s:wa-Ha-p;pc=wa-pa;qc=C;S()}function S(){Fb=s/2;La=0.95*Fb;Gb=ia(k.data.targets,"donut")?0.6*La:0}function fa(){var a=Hb?Hb:+e.select(xa).style("height").replace("px",
"");return 0<a?a:320}function Q(){return+e.select(xa).style("width").replace("px","")}function W(){return r+2+C+$}function oa(){return 40}function Ab(){return C+20}function xd(){return s-q+2}function X(){var a=h?s:r,b=ya(T)/ya(m.domain()),c=gb();return 1<c?a*b/(c-1):a}function Y(){Ib=h?1:0;Jb=h?s:r;Kb=h?0:s;Lb=h?r:1;Mb=h?0:fb;Nb=h?Eb:1;m=ha(Ib,Jb,v(m)?m.domain():void 0,function(){return J.tickOffset()});z=I(Kb,Lb,v(z)?z.domain():void 0);aa=I(Kb,Lb,v(aa)?aa.domain():void 0);U=ha(Ib,Jb,v(T)?T:void 0,
function(a){return 0===a%1?hb.tickOffset():0});ib=I(Mb,Nb);jb=I(Mb,Nb);J=rc(m,zd);za=e.svg.axis().scale(z).orient(Ad);kb=e.svg.axis().scale(aa).orient(Bd);hb=rc(U,Cd);ga()}function ga(){lb=ab();vc=Ja();wc=Ja(0.98)}function ha(a,b,c,d){var f=(D?e.time.scale():e.scale.linear()).range([a,b]);f.orgDomain=function(){return f.domain()};v(c)&&f.domain(c);y(d)&&(d=function(){return 0});if(ja){var H=f,t,f=function(a){return H(a)+d(a)};for(t in H)f[t]=H[t];f.orgDomain=function(){return H.domain()};f.domain=
function(a){if(!arguments.length)return a=H.domain(),[a[0],a[1]+1];H.domain(a);return f}}return f}function I(a,b){return e.scale.linear().range([a,b])}function u(a){return"y2"===R(a)?aa:z}function B(a){return"y2"===R(a)?jb:ib}function rc(a,b){var c=(ja?wd():e.svg.axis()).scale(a).orient(b);c.tickFormat(sc());ja?c.categories(Ma).tickCentered(Dd):c.tickOffset=function(){return 0};return c}function R(a){return a in xc?xc[a]:"y"}function sc(){var a=D?Ed:ja?Fd:function(a){return a};mb&&(a="function"===
typeof mb?mb:D?function(a){return e.time.format(mb)(a)}:a);return a}function Z(a){var b=!1;Ob(k.data.targets).forEach(function(c){b||c.data.id!==a.data.id||(b=!0,a=c)});return b?a:null}function ab(){var a=e.svg.arc().outerRadius(La).innerRadius(Gb),b=function(b,d){var f;return d?a(b):(f=Z(b))?a(f):"M 0 0"};b.centroid=a.centroid;return b}function Ja(a){var b=e.svg.arc().outerRadius(Fb*(a?a:1)).innerRadius(Gb);return function(a){return(a=Z(a))?b(a):"M 0 0"}}function zb(a){a=Z(a);var b,c;b="";a&&(b=
lb.centroid(a),a=b[0],b=b[1],c=Math.sqrt(a*a+b*b),b="translate("+0.8*(a/c)*La+","+0.8*(b/c)*La+")");return b}function yd(a){return Gd(a,(a.endAngle-a.startAngle)/(2*Math.PI))}function yc(a,b){var c=n.selectAll(".chart-arc"+ka(a)),d=n.selectAll(".-arc").filter(function(b){return b.data.id!==a});c.selectAll("path").transition().duration(50).attr("d",vc).transition().duration(100).attr("d",wc).each(function(a){Pb(a.data)});b||d.style("opacity",0.3)}function Qb(a){n.selectAll(".chart-arc"+ka(a)).selectAll("path").transition().duration(50).attr("d",
lb);n.selectAll(".-arc").style("opacity",1)}function Hd(a){var b=zc(a),c,d,f,H;if(0<w.length)for(H=Ac(a),a=0;a<w.length;a++)for(d=w[a][0],H&&b[d]&&b[d].forEach(function(a,c){b[d][c]=0>a?a:0}),c=1;c<w[a].length;c++)f=w[a][c],b[f]&&b[f].forEach(function(a,c){R(f)!==R(d)||!b[d]||H&&0<+a||(b[d][c]+=+a)});return e.min(Object.keys(b).map(function(a){return e.min(b[a])}))}function Id(a){var b=zc(a),c,d,f,H;if(0<w.length)for(H=Jd(a),a=0;a<w.length;a++)for(d=w[a][0],H&&b[d]&&b[d].forEach(function(a,c){b[d][c]=
0<a?a:0}),c=1;c<w[a].length;c++)f=w[a][c],b[f]&&b[f].forEach(function(a,c){R(f)!==R(d)||!b[d]||H&&0>+a||(b[d][c]+=+a)});return e.max(Object.keys(b).map(function(a){return e.max(b[a])}))}function nb(a){var b=ob(function(b){return R(b.id)===a}),c="y2"===a?Kd:Ld,d="y2"===a?Md:Nd,c=c?c:Hd(b),d=d?d:Id(b),f=0.1*Math.abs(d-c),e=f,g=f,h="y2"===a?Od:Pd;h&&(c=Math.max(Math.abs(c),Math.abs(d)),d=c-h,c=h-c);"y"===a&&Na&&(e=Na.top?Na.top:f,g=Na.bottom?Na.bottom:f);"y2"===a&&Oa&&(e=Oa.top?Oa.top:f,g=Oa.bottom?
Oa.bottom:f);ia(b,"bar")&&!Ac(b)&&(g=c);return[c-g,d+e]}function Qd(a){return e.min(a,function(a){return e.min(a.values,function(a){return a.x})})}function Rd(a){return e.max(a,function(a){return e.max(a.values,function(a){return a.x})})}function pb(a){var b=[Qd(a),Rd(a)];a=b[0];var b=b[1],c=ja?0:0.01*Math.abs(a-b);a=D?new Date(a.getTime()-c):a-c;b=D?new Date(b.getTime()+c):b+c;return[a,b]}function ya(a){return a[1]-a[0]}function Sd(a){for(var b=0;b<a.length;b++)if(!(a[b]in qb))return!1;return!0}
function Td(a){for(var b=[],c=0;c<a.length;c++)a[c]in qb&&b.push(Bc(qb[a[c]]));return b}function Rb(a){return"start"in a?m(D?qa(a.start):a.start):0}function Cc(a){var b=Rb(a);a=("end"in a?m(D?qa(a.end):a.end):r)-b;return 0>a?0:a}function Dc(a){return ra&&a===ra||ba&&Ud(ba,a)}function Vd(a){return!Dc(a)}function Wd(a){Object.keys(a).forEach(function(b){ba[b]=a[b]})}function rb(a){var b;a&&(b=Pa[a.id],a.name=b?b:a.id);return a}function Ec(a){var b=a[0],c={},d=[],f,e;for(f=1;f<a.length;f++){c={};for(e=
0;e<a[f].length;e++)c[b[e]]=a[f][e];d.push(c)}return d}function Fc(a){var b=[],c,d,f;for(c=0;c<a.length;c++)for(f=a[c][0],d=1;d<a[c].length;d++)y(b[d-1])&&(b[d-1]={}),b[d-1][f]=a[c][d];return b}function Qa(a){var b=e.keys(a[0]).filter(Vd),c=e.keys(a[0]).filter(Dc);if(D&&0===c.length)return O.alert('data.x or data.xs must be specified when axis.x.type == "timeseries"'),[];Sb&&b.forEach(function(b){var f=ra?ra:ba?ba[b]:null;0<=c.indexOf(f)?k.data.x[b]=a.map(function(a){return a[f]}):k.data.x[b]=k.data.x[Object.keys(k.data.x)[0]]});
b=b.map(function(b){var c=Xd(b);return{id:c,id_org:b,values:a.map(function(a,e){var g;g=ra?ra:ba?ba[b]:null;g=D?qa(a[g]):Sb?a[g]?a[g]:b in k.data.x&&k.data.x[b]&&k.data.x[b][e]?k.data.x[b][e]:e:e;a.x=g;return{x:g,value:null===a[b]||isNaN(a[b])?null:+a[b],id:c}})}});b.forEach(function(a){var b;a.values=a.values.sort(function(a,b){return(a.x||0===a.x?a.x:Infinity)-(b.x||0===b.x?b.x:Infinity)});b=0;a.values.forEach(function(a){a.index=b++})});Gc&&ca(Ra(b).filter(function(a){return!(a in A)}),Gc);b.forEach(function(a){qb[a.id_org]=
Bc(a)});return b}function Bc(a){return{id:a.id,id_org:a.id_org,values:a.values.map(function(a){return{x:a.x,value:a.value,id:a.id}})}}function Hc(a){return 0<a&&k.data.targets[0].values[a-1]?k.data.targets[0].values[a-1].x:void 0}function gb(){return e.max(k.data.targets,function(a){return a.values.length})}function Yd(){var a=k.data.targets.length,b=0,c;1<a?k.data.targets.forEach(function(a){a.values.length>b&&(c=a,b=a.values.length)}):c=a?k.data.targets[0]:null;return c}function Ra(a){a=y(a)?k.data.targets:
...
function(a){var b="<table class='-tooltip'><tr><th colspan='2'>"+sc()(a[0].x)+"</th></tr>",c,d,e,g=cc?cc:function(a){return+a};for(c=0;c<a.length;c++)if(a[c]&&(a[c].value||0===a[c].value)){d="-";if(a[c].value||0===a[c].value)d=g(a[c].value);e=a[c].name;b+="<tr class='-tooltip-name-"+a[c].id+"'><td class='name'><span style='background-color:"+N(a[c].id)+"'></span>"+e+"</td><td class='value'>"+d+"</td></tr>"}return b+"</table>"}),ye=g(["tooltip","init","show"],!1),Ga=g(["tooltip","init","x"],0),md=
g(["tooltip","init","position"],{top:"0px",left:"50px"}),dc=xa.replace("#","")+"-clip",Xa="url("+document.URL+"#"+dc+")",D="timeseries"===vd,ja="categorized"===vd,Sb=!D&&(ra||ba),jc=null,Ya=!1,ic=!1,pa=Fa?40:0,N=function(a,b){var c=[],d=null!==b?b:"#1f77b4 #ff7f0e #2ca02c #d62728 #9467bd #8c564b #e377c2 #7f7f7f #bcbd22 #17becf".split(" ");return function(b){if(b in a)return a[b];-1===c.indexOf(b)&&c.push(b);return d[c.indexOf(b)%d.length]}}(Le,Me),Ed=function(){var a=[[e.time.format("%Y/%-m/%-d"),
...
b){var c=a.__max__+1,d=1<arguments.length?b:!0,e=ja?c?1.2*J.tickOffset()/c:0:0.6*((h?s:r)*(d?1:ya(T)/ya(m.domain()))/(gb()-1)),g=fe(e,c,a,!!d),k=ge(!!d),l=he(a,!!d),n=d?B:u;return function(a,b){var c=n(a.id)(0),d=l(a,b)||c,c=[[g(a),d],[g(a),k(a)-(c-d)],[g(a)+e,k(a)-(c-d)],[g(a)+e,d]],d=h?1:0,m=h?0:1;return"M "+c[0][d]+","+c[0][m]+" L"+c[1][d]+","+c[1][m]+" L"+c[2][d]+","+c[2][m]+" L"+c[3][d]+","+c[3][m]+" z"}},He=function(){var a=e.svg.line().x(h?function(a){return B(a.id)(a.value)}:Pc).y(h?Pc:function(a){return B(a.id)(a.value)});
