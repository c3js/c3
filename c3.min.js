(function(P){function kd(){function u(d,f){d.attr("transform",function(d){return"translate("+(f(d)+ca)+", 0)"})}function x(d,f){d.attr("transform",function(d){return"translate(0,"+f(d)+")"})}function P(d){var f=d[0];d=d[d.length-1];return f<d?[f,d]:[d,f]}function Da(d){for(var f=[],r=Math.ceil(d[0]);r<d[1];r++)f.push(r);0<f.length&&0<f[0]&&f.unshift(f[0]-(f[1]-f[0]));return f}function Ea(d){d=d<da.length?da[d]:d;return N?N(d):d}function n(n){n.each(function(){var n=d.select(this),ia=Da(r.domain()),
R=n.selectAll(".tick.major").data(ia,String),S=R.enter().insert("g","path").attr("class","tick major").style("opacity",1E-6),T=d.transition(R.exit()).style("opacity",1E-6).remove(),w=d.transition(R).style("opacity",1),F,N=r.rangeExtent?r.rangeExtent():P(r.range()),n=n.selectAll(".domain").data([0]);n.enter().append("path").attr("class","domain");var n=d.transition(n),y=r.copy(),da=this.__chart__||y;this.__chart__=y;S.append("line");S.append("text");var ja=S.select("line"),Va=w.select("line"),ka=R.select("text"),
Wa=S.select("text"),Xa=w.select("text");ca=(y(1)-y(0))/2;R=qa?0:ca;switch(A){case "bottom":F=u;ja.attr("y2",O);Wa.attr("y",Math.max(O,0)+f);Va.attr("x1",R).attr("x2",R).attr("y2",O);Xa.attr("x",0).attr("y",Math.max(O,0)+f);ka.attr("dy",".71em").style("text-anchor","middle");ka.text(function(d){return ia.length<X||0===d%Math.ceil(ia.length/X)?Ea(d):""});n.attr("d","M"+N[0]+","+Y+"V0H"+N[1]+"V"+Y);break;case "left":F=x,ja.attr("x2",-O),Wa.attr("x",-(Math.max(O,0)+f)),Va.attr("x2",-O).attr("y2",0),Xa.attr("x",
-(Math.max(O,0)+f)).attr("y",ca),ka.attr("dy",".32em").style("text-anchor","end"),ka.text(function(d){return ia.length<X||0===d%Math.ceil(ia.length/X)?Ea(d):""}),n.attr("d","M"+-Y+","+N[0]+"H0V"+N[1]+"H"+-Y)}if(r.ticks)S.call(F,da),w.call(F,y),T.call(F,y);else{var Ya=y.rangeBand()/2,T=function(d){return y(d)+Ya};S.call(F,T);w.call(F,T)}})}var r=d.scale.linear(),A="bottom",O=6,Y=6,f=3,qa=!1,X=10,ca=0,N=null,da=[];n.scale=function(d){if(!arguments.length)return r;r=d;return n};n.orient=function(d){if(!arguments.length)return A;
A=d in{top:1,right:1,bottom:1,left:1}?d+"":"bottom";return n};n.categories=function(d){if(!arguments.length)return da;da=d;return n};n.tickCentered=function(d){if(!arguments.length)return qa;qa=d;return n};n.tickTextNum=function(d){if(!arguments.length)return X;X=d;return n};n.tickFormat=function(d){if(!arguments.length)return N;N=d;return n};n.tickOffset=function(){return ca};n.ticks=function(){};return n}function x(d){return"undefined"===typeof d}function u(d){return"undefined"!==typeof d}var yb=
P.c3={},d=P.d3;yb.generate=function(ba){var fc,gc,Da,Ea,n,r,A,O,Y;function f(a,b){for(var c=ba,e=0;e<a.length;e++){if(!(a[e]in c))return b;c=c[a[e]]}return c}function qa(){zb=null===Za?ca():Za;ra=X();r=0;A=(g?Ab+jc:0)+($a?$a:ab?1:40);O=20+(g?0:Ab)+la;Y=bb?bb:Bb?cb||g?1:40:20;p=zb-A-Y;t=ra-r-O;Da=g?r:ra-Ab-la;Ea=g?kc:A;n=20+la;Cb=g?A-kc-jc:p;db=g?t:ra-Da-n;fc=ra-la;gc=A;Db=t/2;eb=0.95*Db}function X(){var a=null===lc?+d.select(sa).style("height").replace("px",""):lc;return 0<a?a:320}function ca(){return+d.select(sa).style("width").replace("px",
"")}function N(){return p+2+A+Y}function da(){return 40}function ia(){return A+20}function yb(){return t-r+2}function ld(){var a=g?t:p,b=ta(U)/ta(m.domain()),c=fb();return 1<c?a*b/(c-1):a}function R(){Eb=g?1:0;Fb=g?t:p;Gb=g?0:t;Hb=g?p:1;Ib=g?0:db;Jb=g?Cb:1;m=S(Eb,Fb,u(m)?m.domain():void 0,function(){return J.tickOffset()});z=T(Gb,Hb,u(z)?z.domain():void 0);Z=T(Gb,Hb,u(Z)?Z.domain():void 0);V=S(Eb,Fb,u(U)?U:void 0,function(a){return 0===a%1?gb.tickOffset():0});hb=T(Ib,Jb);ib=T(Ib,Jb);J=hc(m,md);ua=
d.svg.axis().scale(z).orient(nd);jb=d.svg.axis().scale(Z).orient(od);gb=hc(V,pd);kb=Va();mc=ka();nc=ka(0.98)}function S(a,b,c,e){var k=(B?d.time.scale():d.scale.linear()).range([a,b]);k.orgDomain=function(){return k.domain()};u(c)&&k.domain(c);x(e)&&(e=function(){return 0});if(ea){var G=k,f,k=function(a){return G(a)+e(a)};for(f in G)k[f]=G[f];k.orgDomain=function(){return G.domain()};k.domain=function(a){if(!arguments.length)return a=G.domain(),[a[0],a[1]+1];G.domain(a);return k}}return k}function T(a,
...
(a.endAngle-a.startAngle)/(2*Math.PI)).toFixed(1)+"%"}function Ya(a,b){var c=q.selectAll(".chart-arc.target"+(a?"-"+a:"")),e=q.selectAll(".-arc").filter(function(b){return b.data.id!==a});c.selectAll("path").transition().duration(50).attr("d",mc).transition().duration(100).attr("d",nc);b||e.style("opacity",0.3)}function xb(a){q.selectAll(".chart-arc.target"+(a?"-"+a:"")).selectAll("path").transition().duration(50).attr("d",kb);q.selectAll(".-arc").style("opacity",1)}function td(a){var b=pc(a),c,e,
k,G;if(0<s.length)for(G=qc(a),a=0;a<s.length;a++)for(e=s[a][0],G&&b[e]&&b[e].forEach(function(a,c){b[e][c]=0>a?a:0}),c=1;c<s[a].length;c++)k=s[a][c],b[k]&&b[k].forEach(function(a,c){y(k)!==y(e)||!b[e]||G&&0<+a||(b[e][c]+=+a)});return d.min(Object.keys(b).map(function(a){return d.min(b[a])}))}function ud(a){var b=pc(a),c,e,k,G;if(0<s.length)for(G=vd(a),a=0;a<s.length;a++)for(e=s[a][0],G&&b[e]&&b[e].forEach(function(a,c){b[e][c]=0<a?a:0}),c=1;c<s[a].length;c++)k=s[a][c],b[k]&&b[k].forEach(function(a,
...
a)return!0;return!1}function nb(a){return u(a)?h.data.targets.filter(a):h.data.targets}function pc(a){var b={};a.forEach(function(a){b[a.id]=[];a.values.forEach(function(e){b[a.id].push(e.value)})});return b}function yc(a,b){var c=Object.keys(a),e,k,d;for(e=0;e<c.length;e++)for(d=a[c[e]].values,k=0;k<d.length;k++)if(b(d[k].value))return!0;return!1}function qc(a){return yc(a,function(a){return 0>a})}function vd(a){return yc(a,function(a){return 0<a})}function sd(a){return a<Fa.length?Fa[a]:a}function La(a){return"-shapes -shapes-"+
...
Hc(k,b)):Gc(a,b,c,e)}function Ic(a,b){var c;c=a.map(function(a){return Gc(a.values,b)});return Hc(c,b)}function Hc(a,b){var c,e;a.forEach(function(a){var d=Nb(a,b);if(d<c||!c)c=d,e=a});return e}function Jc(a,b){var c,e,k,d,f;0!==a.filter(function(a){return a.value}).length&&(W.html(Kc(a)).style("visibility","hidden").style("display","block"),c=W.property("offsetWidth"),e=W.property("offsetHeight"),g?d=b[0]:(k=q.property("offsetLeft"),d=k+($a?$a:ab?1:40)+m(a[0].x)+20,f=d+c,k=k+(null===Za?ca():Za)-
...
(a||0===a?"-"+a:""))}function $d(a,b,c,e){var d,f,h="M",l,m,ya,n,r,p=[];if(u(e))for(d=0;d<e.length;d++)p[d]={},x(e[d].start)?p[d].start=a[0].x:p[d].start=B?ma(e[d].start):e[d].start,x(e[d].end)?p[d].end=a[a.length-1].x:p[d].end=B?ma(e[d].end):e[d].end;n=g?function(a){return c(a.value)}:function(a){return b(a.x)};r=g?function(a){return b(a.x)}:function(a){return c(a.value)};e=B?function(a,e,d,k){var f=a.x.getTime();a=e.x-a.x;e=new Date(f+a*(d+k));return"M"+b(new Date(f+a*d))+" "+c(m(d))+" "+b(e)+" "+
c(m(d+k))}:function(a,e,d,k){return"M"+b(l(d))+" "+c(m(d))+" "+b(l(d+k))+" "+c(m(d+k))};for(d=0;d<a.length;d++)if(x(p)||!Wd(a[d].x,p))h+=" "+n(a[d])+" "+r(a[d]);else{l=S(a[d-1].x,a[d].x);m=T(a[d-1].value,a[d].value);f=b(a[d].x)-b(a[d-1].x);ya=c(a[d].value)-c(a[d-1].value);f=Math.sqrt(Math.pow(f,2)+Math.pow(ya,2));ya=2/f;var q=2*ya;for(f=ya;1>=f;f+=q)h+=e(a[d-1],a[d],f,ya)}return h}function Vb(a){var b;tb=d.select(sa);if(tb.empty())P.alert('No bind element found. Check the selector specified by "bindto" and existance of that element. Default "bindto" is "#chart".');
...
Wb).append("rect").attr("y",r).attr("width",p).attr("height",t-r);ub.append("clipPath").attr("id","xaxis-clip").append("rect").attr("x",-1-A).attr("y",-20).attr("width",N).attr("height",da);ub.append("clipPath").attr("id","yaxis-clip").append("rect").attr("x",-A+1).attr("y",r-1).attr("width",ia).attr("height",yb);l=q.append("g").attr("transform",M.main);E=za?q.append("g").attr("transform",M.context):null;Aa=Ba?q.append("g").attr("transform",M.legend):null;W=d.select(sa).style("position","relative").append("div").style("position",
...
0:-r).attr("dy",-5).text(function(a){return a.text}));ie&&a.append("g").attr("class","xgrid-focus").append("line").attr("class","xgrid-focus").attr("x1",g?0:-10).attr("x2",g?p:-10).attr("y1",g?-10:r).attr("y2",g?-10:t);Yc&&a.append("g").attr("class","ygrids");Yb&&(a=a.append("g").attr("class","ygrid-lines").selectAll("ygrid-line").data(Yb).enter().append("g").attr("class","ygrid-line"),a.append("line").attr("class",function(a){return""+a["class"]}),a.append("text").attr("class",function(a){return""+
a["class"]}).attr("text-anchor","end").attr("transform",g?"rotate(-90)":"").attr("dx",g?0:-r).attr("dy",-5).text(function(a){return a.text}));l.append("g").attr("clip-path",Qa).attr("class","regions");l.append("g").attr("clip-path",Qa).attr("class","chart");l.select(".chart").append("g").attr("class","event-rects").style("fill-opacity",0).style("cursor",oa?"ew-resize":null);l.select(".chart").append("g").attr("class","chart-bars");l.select(".chart").append("g").attr("class","chart-lines");l.select(".chart").append("g").attr("class",
"chart-arcs").attr("transform",M.arc);if(oa)l.insert("rect",je?null:"g.grid").attr("class","zoom-rect").attr("width",p).attr("height",t).style("opacity",0).style("cursor","ew-resize").call(D).on("dblclick.zoom",null);null!==vb&&L.extent("function"!==typeof vb?vb:vb(ob()));za&&(E.append("g").attr("clip-path",Qa).attr("class","chart"),E.select(".chart").append("g").attr("class","chart-bars"),E.select(".chart").append("g").attr("class","chart-lines"),E.append("g").attr("clip-path",Qa).attr("class","x brush").call(L).selectAll("rect").attr(g?
"width":"height",g?Cb:db),E.append("g").attr("class","x axis").attr("transform",M.subx).attr("clip-path",g?"url(#yaxis-clip)":"").call(gb));Ba&&wb(h.data.targets);Zc(h.data.targets);I({withTransition:!1,withUpdateXDomain:!0});if(ke){if(B&&"string"===typeof Ca){Ca=ma(Ca);for(a=0;a<h.data.targets[0].values.length&&0!==h.data.targets[0].values[a].x-Ca;a++);Ca=a}W.html(Kc(h.data.targets.map(function(a){return qb(a.values[Ca])})));W.style("top",$c.top).style("left",$c.left).style("display","block")}null==
P.onresize&&(P.onresize=le());P.onresize.add&&P.onresize.add(me)}}function ne(a){a.append("rect").attr("class",Cc).style("cursor",fa&&pa?"pointer":null).on("mouseover",function(a,c){if(!Ra&&!C(h.data.targets)){var e=h.data.targets.map(function(a){return qb(a.values[c])}),d,f;if(0<Object.keys(Ja).length){f=[];for(var g in Ja)for(d=0;d<e.length;d++)if(e[d].id===g){f.push(e[d]);e.shift(d);break}e=f.concat(e)}Zb&&Sb(c,void 0).classed(aa,!0).attr("r",$b);Wc(c).classed(aa,!1);Lc(e[0])}}).on("mouseout",
function(a,c){C(h.data.targets)||(Mc(),W.style("display","none"),Tb(c),Wc(void 0).classed(aa,!1))}).on("mousemove",function(a,c){var e;Ra||C(h.data.targets)||(e=h.data.targets.map(function(a){return qb(a.values[c])}),Jc(e,d.mouse(this)),fa&&(pa||l.selectAll(".-shape-"+c).filter(function(a){return ga(a)}).each(function(){var a=d.select(this).classed(aa,!0);"circle"===this.nodeName&&a.attr("r",$b);q.select(".event-rect-"+c).style("cursor",null)}).filter(function(){var a=d.select(this);if("circle"===
this.nodeName)return Qc(this,Pa);if("rect"===this.nodeName)return Rc(this,a.attr("x"),a.attr("y"))}).each(function(){var a=d.select(this);a.classed(aa)||(a.classed(aa,!0),"circle"===this.nodeName&&a.attr("r",Pa));q.select(".event-rect-"+c).style("cursor","pointer")})))}).on("click",function(a,c){C(h.data.targets)||(ac?ac=!1:l.selectAll(".-shape-"+c).each(function(a){ad(this,a,c)}))}).call(d.behavior.drag().origin(Object).on("drag",function(){bd(d.mouse(this))}).on("dragstart",function(){cd(d.mouse(this))}).on("dragend",
function(){dd()})).call(D).on("dblclick.zoom",null)}function oe(a){a.append("rect").attr("x",0).attr("y",0).attr("width",p).attr("height",t).attr("class","event-rect").on("mouseout",function(){C(h.data.targets)||(Mc(),W.style("display","none"),Tb())}).on("mousemove",function(){var a,c,e;Ra||C(h.data.targets)||(a=d.mouse(this),c=Ic(h.data.targets,a),e=[qb(c)],Jc(e,a),Zb&&(Tb(),Sb(c.index,c.id).classed(aa,!0).attr("r",$b)),Lc(e[0]),100>Nb(c,a)?q.select(".event-rect").style("cursor","pointer"):q.select(".event-rect").style("cursor",
null))}).on("click",function(){var a,c;C(h.data.targets)||(a=d.mouse(this),c=Ic(h.data.targets,a),100>Nb(c,a)&&l.select(".-circles-"+c.id).select(".-circle-"+c.index).each(function(){ad(this,c,c.index)}))}).call(d.behavior.drag().origin(Object).on("drag",function(){bd(d.mouse(this))}).on("dragstart",function(){cd(d.mouse(this))}).on("dragend",function(){dd()})).call(D).on("dblclick.zoom",null)}function ad(a,b,c){var e=d.select(a),f=e.classed(ha),g=!1,h;"circle"===a.nodeName?(g=Qc(a,1.5*Pa),h=Tc):
"rect"===a.nodeName&&(g=Rc(a),h=Vc);if(pa||g)fa&&ga(b)&&(e.classed(ha,!f),h(!f,e,b,c)),pe(b,e)}function bd(a){var b,c,e,f,g,m,p;C(h.data.targets)||!fa||oa&&!D.altDomain||(b=bc[0],c=bc[1],e=a[0],a=a[1],f=Math.min(b,e),g=Math.max(b,e),m=pa?r:Math.min(c,a),p=pa?t:Math.max(c,a),l.select(".dragarea").attr("x",f).attr("y",m).attr("width",g-f).attr("height",p-m),l.selectAll(".-shapes").selectAll(".-shape").filter(function(a){return ga(a)}).each(function(a,b){var c=d.select(this),e=c.classed(ha),h=c.classed(cc),
l,n,r,q;l=!1;"circle"===this.nodeName?(l=1*c.attr("cx"),n=1*c.attr("cy"),q=Tc,l=f<l&&l<g&&m<n&&n<p):"rect"===this.nodeName&&(l=1*c.attr("x"),n=1*c.attr("y"),r=1*c.attr("width"),q=Vc,l=f<l+r&&l<g&&n<p);l^h&&(c.classed(cc,!h),c.classed(ha,!e),q(!e,c,a,b))}))}function cd(a){!C(h.data.targets)&&fa&&(bc=a,l.select(".chart").append("rect").attr("class","dragarea").style("opacity",0.1),Ra=!0)}function dd(){!C(h.data.targets)&&fa&&(l.select(".dragarea").transition().duration(100).style("opacity",0).remove(),
l.selectAll(".-shape").classed(cc,!1),Ra=!1)}function I(a){var b,c,e,f=Rd(),n=f.__max__+1,q,v,s;a=u(a)?a:{};c=u(a.withY)?a.withY:!0;e=u(a.withSubchart)?a.withSubchart:!0;v=u(a.withTransition)?a.withTransition:!0;b=u(a.withUpdateXDomain)?a.withUpdateXDomain:!1;a=u(a.withUpdateOrgXDomain)?a.withUpdateOrgXDomain:!1;s=C(h.data.targets);v=v?250:0;a&&(m.domain(d.extent(ob(h.data.targets))),U=m.domain(),D.scale(m).updateScaleExtent(),V.domain(m.domain()),L.scale(V));b&&(m.domain(L.empty()?U:L.extent()),
oa&&D.scale(m).updateScaleExtent());z.domain(mb("y"));Z.domain(mb("y2"));l.select(".x.axis").transition().duration(g?v:0).call(g?ua:J).style("opacity",s?0:1);l.select(".y.axis").transition().duration(g?0:v).call(g?J:ua).style("opacity",s?0:1);l.select(".y2.axis").transition().call(jb).style("opacity",s?0:1);l.select(".x.axis .-axis-x-label").attr("x",p);hb.domain(z.domain());ib.domain(Z.domain());W.style("display","none");l.select("line.xgrid-focus").style("visibility","hidden").attr("y2",t);if(Xc){if("year"===
qe)for(b=[],s=ob(),a=s[0].getFullYear(),s=s[1].getFullYear();a<=s;a++)b.push(new Date(a+"-01-01 00:00:00"));else b=m.ticks(10);b=l.select(".xgrids").selectAll(".xgrid").data(b);b.enter().append("line").attr("class","xgrid");b.attr("x1",g?0:function(a){return m(a)-J.tickOffset()}).attr("x2",g?p:function(a){return m(a)-J.tickOffset()}).attr("y1",g?function(a){return m(a)-J.tickOffset()}:r).attr("y2",g?function(a){return m(a)-J.tickOffset()}:t).style("opacity",function(){return+d.select(this).attr(g?
"y1":"x1")===(g?t:0)?0:1});b.exit().remove()}Xb&&(b=l.selectAll(".xgrid-lines"),b.selectAll("line").transition().duration(v).attr("x1",g?0:Ma).attr("x2",g?p:Ma).attr("y1",g?Ma:r).attr("y2",g?Ma:t),b.selectAll("text").attr("x",g?p:0).attr("y",Ma));c&&Yc&&(b=l.select(".ygrids").selectAll(".ygrid").data(z.ticks(10)),b.enter().append("line").attr("class","ygrid"),b.attr("x1",g?z:0).attr("x2",g?z:p).attr("y1",g?0:z).attr("y2",g?t:z),b.exit().remove());c&&Yb&&(c=l.select(".ygrid-lines"),c.selectAll("line").transition().duration(v).attr("x1",
g?Na:0).attr("x2",g?Na:p).attr("y1",g?0:Na).attr("y2",g?t:Na),c.selectAll("text").attr("x",g?0:p).attr("y",Na));c=function(a){var b=ea?n?1.2*J.tickOffset()/n:0:0.6*((g?t:p)*(a?1:ta(U)/ta(m.domain()))/(fb()-1)),c=Sd(b,n,f,!!a),e=Td(!!a),d=Ud(f,!!a),h=a?F:w;return function(a,f){var k=h(a.id)(0),l=d(a,f)||k,k=[[c(a),l],[c(a),e(a)-(k-l)],[c(a)+b,e(a)-(k-l)],[c(a)+b,l]],l=g?1:0,m=g?0:1;return"M "+k[0][l]+","+k[0][m]+" L"+k[1][l]+","+k[1][m]+" L"+k[2][l]+","+k[2][m]+" L"+k[3][l]+","+k[3][m]+" z"}};b=l.selectAll(".-bars").selectAll(".-bar").data(Pc);
...
c(!0)).style("opacity",1),e.exit().transition().duration(v).style("opacity",0).remove(),E.selectAll(".-line").transition().duration(v).attr("d",te)));l.selectAll(".selected-circles").filter(function(a){return sb(a)}).selectAll("circle").remove();l.selectAll(".selected-circle").transition().duration(v).attr("cx",g?xa:wa).attr("cy",g?wa:xa);$?(c=l.select(".event-rects").selectAll(".event-rect").data([0]),oe(c.enter()),c.attr("x",0).attr("y",0).attr("width",p).attr("height",t)):(Mb?(q=function(a,b){var c=
wc(b),e=b<fb()-1?h.data.targets[0].values[b+1].x:void 0;return(m(e?e:a.x+50)-m(c?c:a.x-50))/2},e=function(a,b){var c=wc(b);return(m(a.x)+m(c?c:a.x-50))/2}):(q=ld(),e=function(a){return m(a.x)-q/2}),c=Kd(),l.select(".event-rects").datum(c?c.values:[]),c=l.select(".event-rects").selectAll(".event-rect").data(function(a){return a}),ne(c.enter()),c.attr("class",Cc).attr("x",g?0:e).attr("y",g?e:0).attr("width",g?p:q).attr("height",g?q:t),c.exit().remove());e=l.select(".regions").selectAll("rect.region").data(Q);
e.enter().append("rect");e.attr("class",Pd).attr("x",g?0:Lb).attr("y",g?Lb:r).attr("width",g?p:sc).attr("height",g?sc:t).style("fill-opacity",function(a){return u(a.opacity)?a.opacity:0.1});e.exit().transition().duration(v).style("fill-opacity",0).remove()}function ue(){"mousemove"===d.event.sourceEvent.type&&D.altDomain?(m.domain(D.altDomain),D.scale(m).updateScaleExtent()):(ea&&m.orgDomain()[0]===U[0]&&m.domain([U[0]-1E-10,m.orgDomain()[1]]),I({withTransition:!1,withY:!1,withSubchart:!1}),"mousemove"===
d.event.sourceEvent.type&&(ac=!0))}function le(){function a(){b.forEach(function(a){a()})}var b=[];a.add=function(a){b.push(a)};return a}function me(){qa();R();L.scale(V);oa&&D.scale(m);q.attr("width",zb).attr("height",ra);q.select("#"+Wb).select("rect").attr("width",p).attr("height",t);q.select("#xaxis-clip").select("rect").attr("width",N);q.select(".zoom-rect").attr("width",p).attr("height",t);l.select(".x.axis").attr("transform",M.x);l.select(".y2.axis").attr("transform",M.y2);l.select(".chart-arcs").attr("transform",
...
a.id}).style("opacity",0),b.append("g").attr("class",Ac).style("fill",function(a){return K(a.id)}),b=E.select(".chart-lines").selectAll(".chart-line").data(a),b=b.enter().append("g").attr("class",function(a){return"chart-line target target-"+a.id}).style("opacity",0),b.append("path").attr("class",zc).style("stroke",function(a){return K(a.id)}));Ba&&wb(a);q.selectAll(".target").transition().style("opacity",1)}function Sa(a,b){h.data.targets.forEach(function(b){for(var e=0;e<a.length;e++)if(b.id===
a[e].id){b.values=a[e].values;a.splice(e,1);break}});h.data.targets=h.data.targets.concat(a);Zc(h.data.targets);I({withUpdateOrgXDomain:!0,withUpdateXDomain:!0});b()}function fd(a){q.selectAll(".legend-item").filter(function(b){return b!==a}).transition().duration(100).style("opacity",0.3)}function gd(){q.selectAll(".legend-item").transition().duration(100).style("opacity",1)}function wb(a,b){var c=rb(a),e,d=p/2-Ta*Object.keys(a).length/2,f;b=x(b)?{}:b;f=u(b.withTransition)?b.withTransition:!0;e=
...
function(a){return K(a)}).attr("x",-200).attr("y",function(){return la/2-9}).attr("width",10).attr("height",10);e.append("text").text(function(a){return u(Ja[a])?Ja[a]:a}).style("pointer-events","none").attr("x",-200).attr("y",function(){return la/2});Aa.selectAll("rect.legend-item-event").data(c).transition().duration(f?250:0).attr("x",function(a,b){return d+Ta*b});Aa.selectAll("rect.legend-item-tile").data(c).transition().duration(f?250:0).attr("x",function(a,b){return d+Ta*b});Aa.selectAll("text").data(c).transition().duration(f?
250:0).attr("x",function(a,b){return d+Ta*b+14})}function Ua(a){return u(a)?".target-"+a:".target"}function dc(a){return xc(a.id)}function ec(a){return"data"in a&&xc(a.data.id)}var h={data:{}},pb={},aa="_expanded_",ha="_selected_",cc="_included_",sa=f(["bindto"],"#chart"),Za=f(["size","width"],null),lc=f(["size","height"],null),$a=f(["padding","left"],null),bb=f(["padding","right"],null),oa=f(["zoom","enabled"],!1),hd=f(["zoom","extent"],null),je=f(["zoom","privileged"],!1),ee=f(["onenter"],function(){}),
fe=f(["onleave"],function(){});if(!("data"in ba))throw Error("data is required in config");var na=f(["data","x"],null),$=f(["data","xs"],null),Pb=f(["data","x_format"],"%Y-%m-%d"),Jd=f(["data","id_converter"],function(a){return a}),Ja=f(["data","names"],{}),s=f(["data","groups"],[]),oc=f(["data","axes"],{}),ed=f(["data","type"],null),H=f(["data","types"],{}),id=f(["data","regions"],{}),we=f(["data","colors"],{}),fa=f(["data","selection","enabled"],!1),pa=f(["data","selection","grouped"],!1),ga=f(["data",
...
E.select(".x.brush").call(this);return this};L.scale=function(a){return g?this.y(a):this.x(a)};D.scale=function(a){return g?this.y(a):this.x(a)};D.orgScaleExtent=function(){var a=hd?hd:[1,10];return[a[0],Math.max(fb()/a[1],a[1])]};D.updateScaleExtent=function(){var a=ta(m.orgDomain())/ta(U),b=this.orgScaleExtent();this.scaleExtent([b[0]*a,b[1]*a]);return this};var q,ub,l,E,Aa,W,tb,U;h.focus=function(a){var b=q.selectAll(Ua(a)),c=b.filter(dc),b=b.filter(ec);h.defocus();c.classed("focused",!0).transition().duration(100).style("opacity",
1);b.transition().duration(100).style("opacity",1);C(h.data.targets)&&Ya(a,!0)};h.defocus=function(a){var b=q.selectAll(Ua(a)),c=b.filter(dc),b=b.filter(ec);c.classed("focused",!1).transition().duration(100).style("opacity",0.3);b.transition().duration(100).style("opacity",0.3);C(h.data.targets)&&xb(a)};h.revert=function(a){var b=q.selectAll(Ua(a)),c=b.filter(dc),b=b.filter(ec);c.classed("focused",!1).transition().duration(100).style("opacity",1);b.transition().duration(100).style("opacity",1);C(h.data.targets)&&
xb(a)};h.show=function(a){q.selectAll(Ua(a)).transition().style("opacity",1)};h.hide=function(a){q.selectAll(Ua(a)).transition().style("opacity",0)};h.unzoom=function(){L.clear().update();I({withUpdateXDomain:!0})};h.load=function(a){"function"!==typeof a.done&&(a.done=function(){});a.xs&&Id(a.xs);"categories"in a&&ea&&(Fa=a.categories,J.categories(Fa));if("cacheIds"in a&&Ed(a.cacheIds))Sa(Fd(a.cacheIds),a.done);else if("data"in a)Sa(Ka(a.data),a.done);else if("url"in a)d.csv(a.url,function(b,c){Sa(Ka(c),
a.done)});else if("rows"in a)Sa(Ka(uc(a.rows)),a.done);else if("columns"in a)Sa(Ka(vc(a.columns)),a.done);else throw Error("url or rows or columns is required.");};h.unload=function(a){h.data.targets=h.data.targets.filter(function(b){return b.id!==a});q.selectAll(".target-"+a).transition().style("opacity",0).remove();Ba&&(q.selectAll(".legend-item-"+a).remove(),wb(h.data.targets));0<h.data.targets.length&&I({withUpdateOrgXDomain:!0,withUpdateXDomain:!0})};h.selected=function(a){a=u(a)?"-"+a:"";return d.merge(l.selectAll(".-shapes"+
a).selectAll(".-shape").filter(function(){return d.select(this).classed(ha)}).map(function(a){return a.map(function(a){return a.__data__})}))};h.select=function(a,b,c){fa&&l.selectAll(".-shapes").selectAll(".-shape").each(function(e,f){var g="circle"===this.nodeName?Sc:Zd,h="circle"===this.nodeName?Qb:Uc;0<=b.indexOf(f)?ga(e)&&(pa||x(a)||0<=a.indexOf(e.id))&&g(d.select(this).classed(ha,!0),e,f):u(c)&&c&&h(d.select(this).classed(ha,!1),e,f)})};h.unselect=function(a,b){fa&&l.selectAll(".-shapes").selectAll(".-shape").each(function(c,
e){var f="circle"===this.nodeName?Qb:Uc;(x(b)||0<=b.indexOf(e))&&ga(c)&&(pa||x(a)||0<=a.indexOf(c.id))&&f(d.select(this).classed(ha,!1),c,e)})};h.toLine=function(a){Oa(a,"line");I()};h.toSpline=function(a){Oa(a,"spline");I()};h.toBar=function(a){Oa(a,"bar");I()};h.toScatter=function(a){Oa(a,"scatter");I()};h.groups=function(a){if(x(a))return s;s=a;I();return s};h.regions=function(a){if(x(a))return Q;Q=a;I();return Q};h.regions.add=function(a){if(x(a))return Q;Q=Q.concat(a);I();return Q};h.regions.remove=
function(a,b){var c=[].concat(a);b=u(b)?b:{};c.forEach(function(a){var c=q.selectAll("."+a);u(b.duration)&&(c=c.transition().duration(b.duration).style("fill-opacity",0));c.remove();Q=Q.filter(function(b){return 0>b.classes.indexOf(a)})});return Q};h.data.get=function(a){a=h.data.getAsTarget(a);return u(a)?a.values.map(function(a){return a.value}):void 0};h.data.getAsTarget=function(a){var b=nb(function(b){return b.id===a});return 0<b.length?b[0]:void 0};h.destroy=function(){h.data.targets=void 0;
